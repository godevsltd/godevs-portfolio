<?php
/**
 * Title: Demo — Professional (Contact)
 * Slug: godevs-portfolio/demo-professional-contact
 * Description: Contact page for the Professional demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, professional, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@professional.studio">hello@professional.studio</a></p>
<!-- /wp:paragraph -->
