<?php
/**
 * Title: Demo — Interior (Contact)
 * Slug: godevs-portfolio/demo-interior-contact
 * Description: Contact page for the Interior demo. Split form + info layout with optional FAQ. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, interior, contact, form, email, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@interior.studio">hello@interior.studio</a></p>
<!-- /wp:paragraph -->
