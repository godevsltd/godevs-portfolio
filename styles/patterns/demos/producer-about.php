<?php
/**
 * Title: Demo — Producer (About)
 * Slug: godevs-portfolio/demo-producer-about
 * Description: About page for the Producer demo. Bio intro, practice areas, and a closing CTA. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, producer, about, bio, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Producer, a music producer portfolio.</p>
<!-- /wp:paragraph -->
