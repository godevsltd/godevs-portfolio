<?php
/**
 * Title: Demo — Northline (Work)
 * Slug: godevs-portfolio/demo-northline-work
 * Description: Work page for the Northline demo. 3-column portfolio grid with selected projects. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, northline, work, portfolio, grid, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
