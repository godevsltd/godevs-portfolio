<?php
/**
 * Title: Demo — Grid City (Work)
 * Slug: godevs-portfolio/demo-grid-city-work
 * Description: Work page for the Grid City demo. 2-column portfolio grid with selected projects. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, grid-city, work, portfolio, grid, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
