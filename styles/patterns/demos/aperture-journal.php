 ...
 * Description: Journal page for the Aperture demo. Behind-the-scenes notes from photo shoots. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, aperture, journal, blog, photography
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
