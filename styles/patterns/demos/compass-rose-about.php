<?php
/**
 * Title: Demo — Compass Rose (About)
 * Slug: godevs-portfolio/demo-compass-rose-about
 * Description: About page for the Compass Rose demo. Bio intro, practice areas, and a closing CTA. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, compass-rose, about, bio, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Compass Rose is a consulting practice helping teams make better decisions about their products and processes.</p>
<!-- /wp:paragraph -->
