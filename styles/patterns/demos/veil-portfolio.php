<?php
/**
 * Title: Demo — Veil (Work)
 * Slug: godevs-portfolio/demo-veil-work
 * Description: Work page for the Veil demo. 2-column portfolio grid with selected projects. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, veil, work, portfolio, grid, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
