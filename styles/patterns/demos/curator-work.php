<?php
/**
 * Title: Demo — Curator (Work)
 * Slug: godevs-portfolio/demo-curator-work
 * Description: Work page for the Curator demo. 2-column portfolio grid with selected projects. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, curator, work, portfolio, grid, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
