<?php
/**
 * Title: Demo — Atelier Arch (Work)
 * Slug: godevs-portfolio/demo-atelier-arch-work
 * Description: Work page for the Atelier Arch demo. 2-column portfolio grid with selected projects. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, atelier-arch, work, portfolio, grid, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
