<?php
/**
 * Title: Demo — Studio Noir (Work)
 * Slug: godevs-portfolio/demo-studio-noir-work
 * Description: Work page for the Studio Noir demo. 2-column portfolio grid with selected projects. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, studio-noir, work, portfolio, grid, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
