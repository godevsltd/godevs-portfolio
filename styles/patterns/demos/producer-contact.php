<?php
/**
 * Title: Demo — Producer (Contact)
 * Slug: godevs-portfolio/demo-producer-contact
 * Description: Contact page for the Producer demo. Split form + info layout with optional FAQ. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, producer, contact, form, email, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@producer.studio">hello@producer.studio</a></p>
<!-- /wp:paragraph -->
