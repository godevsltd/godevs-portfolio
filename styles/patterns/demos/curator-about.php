<?php
/**
 * Title: Demo — Curator (About)
 * Slug: godevs-portfolio/demo-curator-about
 * Description: About page for the Curator demo. Bio intro, practice areas, and a closing CTA. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, curator, about, bio, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Curator, a art curator portfolio.</p>
<!-- /wp:paragraph -->
