<?php
/**
 * Title: Demo — Speaker (About)
 * Slug: godevs-portfolio/demo-speaker-about
 * Description: About page for the Speaker demo. Bio intro, practice areas, and a closing CTA. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, speaker, about, bio, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Speaker, a speaker site.</p>
<!-- /wp:paragraph -->
