...
/**
 * Title: Demo — PM (About)
 * Slug: godevs-portfolio/demo-pm-about
 * Description: About page for the PM demo. Bio intro, practice areas, and a closing CTA. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, pm, about, bio, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm PM, a product manager portfolio.</p>
<!-- /wp:paragraph -->
