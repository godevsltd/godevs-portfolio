<?php
/**
 * Title: Demo — Darkroom (About)
 * Slug: godevs-portfolio/demo-darkroom-about
 * Description: About page for the Darkroom demo. Bio intro, practice areas, and a closing CTA. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, darkroom, about, bio, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Darkroom is a photography practice working across editorial, product, and portrait commissions.</p>
<!-- /wp:paragraph -->
