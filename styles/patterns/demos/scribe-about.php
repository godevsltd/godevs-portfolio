<?php
/**
 * Title: Demo — Scribe (About)
 * Slug: godevs-portfolio/demo-scribe-about
 * Description: About page for the Scribe demo. Bio intro, practice areas, and a closing CTA. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, scribe, about, bio, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Scribe, a author site.</p>
<!-- /wp:paragraph -->
