<?php
/**
 * Title: Demo — Fieldnotes (Work)
 * Slug: godevs-portfolio/demo-fieldnotes-work
 * Description: Work page for the Fieldnotes demo. 2-column portfolio grid with selected projects. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, fieldnotes, work, portfolio, grid, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
