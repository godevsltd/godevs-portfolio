<?php
/**
 * Title: Demo — Draft (About)
 * Slug: godevs-portfolio/demo-draft-about
 * Description: About page for the Draft demo. Bio intro, practice areas, and a closing CTA. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, draft, about, bio, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Draft is a design practice focused on identity, editorial, and product work.</p>
<!-- /wp:paragraph -->
