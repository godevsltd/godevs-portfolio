<?php
/**
 * Title: Demo — Inkwell (About)
 * Slug: godevs-portfolio/demo-inkwell-about
 * Description: About page for the Inkwell demo. Bio intro, practice areas, and a closing CTA. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, inkwell, about, bio, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Inkwell is a design practice focused on identity, editorial, and product work.</p>
<!-- /wp:paragraph -->
