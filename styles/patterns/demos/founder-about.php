<?php
/**
 * Title: Demo — Founder (About)
 * Slug: godevs-portfolio/demo-founder-about
 * Description: About page for the Founder demo. Bio intro, practice areas, and a closing CTA. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, founder, about, bio, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Founder, a entrepreneur site.</p>
<!-- /wp:paragraph -->
