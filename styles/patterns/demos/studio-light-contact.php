<?php
/**
 * Title: Demo — Studio Light (Contact)
 * Slug: godevs-portfolio/demo-studio-light-contact
 * Description: Contact page for the Studio Light demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, studio-light, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@studio-light.studio">hello@studio-light.studio</a></p>
<!-- /wp:paragraph -->
