<?php
/**
 * Title: Demo — Lifestyle (Work)
 * Slug: godevs-portfolio/demo-lifestyle-work
 * Description: Work page for the Lifestyle demo. 3-column portfolio grid with selected projects. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, lifestyle, work, portfolio, grid, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
