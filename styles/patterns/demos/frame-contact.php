<?php
/**
 * Title: Demo — Frame (Contact)
 * Slug: godevs-portfolio/demo-frame-contact
 * Description: Contact page for the Frame demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, frame, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@frame.studio">hello@frame.studio</a></p>
<!-- /wp:paragraph -->
