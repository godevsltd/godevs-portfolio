<?php
/**
 * Title: Demo — Foundry (About)
 * Slug: godevs-portfolio/demo-foundry-about
 * Description: About page for the Foundry demo. Bio intro, practice areas, and a closing CTA. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, foundry, about, bio, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Foundry is an independent practice working at the intersection of design and engineering.</p>
<!-- /wp:paragraph -->
