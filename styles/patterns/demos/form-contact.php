<?php
/**
 * Title: Demo — Form (Contact)
 * Slug: godevs-portfolio/demo-form-contact
 * Description: Contact page for the Form demo. Split form + info layout with optional FAQ. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, form, contact, form, email, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@form.studio">hello@form.studio</a></p>
<!-- /wp:paragraph -->
