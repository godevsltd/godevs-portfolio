<?php
/**
 * Title: Demo — Concise (Work)
 * Slug: godevs-portfolio/demo-concise-work
 * Description: Work page for the Concise demo. 2-column portfolio grid with selected projects. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, concise, work, portfolio, grid, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
