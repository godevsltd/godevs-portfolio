...
/**
 * Title: Demo — Lux (Work)
 * Slug: godevs-portfolio/demo-lux-work
 * Description: Work page for the Lux demo. 2-column portfolio grid with selected projects. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, lux, work, portfolio, grid, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
