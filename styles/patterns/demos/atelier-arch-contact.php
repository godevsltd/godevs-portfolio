<?php
/**
 * Title: Demo — Atelier Arch (Contact)
 * Slug: godevs-portfolio/demo-atelier-arch-contact
 * Description: Contact page for the Atelier Arch demo. Split form + info layout with optional FAQ. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, atelier-arch, contact, form, email, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@atelier-arch.studio">hello@atelier-arch.studio</a></p>
<!-- /wp:paragraph -->
