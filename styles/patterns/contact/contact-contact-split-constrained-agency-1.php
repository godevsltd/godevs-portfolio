<?php
/**
 * Title: Contact — Contact Split (Agency)
 * Slug: godevs-portfolio/contact-contact-split-constrained-agency-1
 * Description: A contact split contact section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-contact
 * Keywords: contact, contact split, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
