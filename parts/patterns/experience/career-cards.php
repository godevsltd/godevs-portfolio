<?php
/**
 * Title: Experience — Career Cards
 * Slug: godevs-portfolio/experience-career-cards
 * Description: A three-column grid of bordered cards each summarizing a role with organization name, role, dates, and a short description. Distinct in its card-grid composition.
 * Categories: godevs-portfolio-experience
 * Keywords: experience, cards, grid, roles, career
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-experience-career-cards godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-experience-career-cards alignfull">
		...
		<div class="wp-block-columns">
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group is-style-card-bordered" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
					<!-- wp:paragraph {"className":"is-style-eyebrow"} -->
					<p class="is-style-eyebrow">Independent</p>
					<!-- /wp:paragraph -->
					<!-- wp:heading {"level":3} -->
					<h3 class="wp-block-heading">Designer &amp; Developer</h3>
					<!-- /wp:heading -->
					...
					<!-- /wp:paragraph -->
					<!-- wp:paragraph -->
					<p>Portfolio, product, and publication sites — design through build.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group is-style-card-bordered" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
					<!-- wp:paragraph {"className":"is-style-eyebrow"} -->
					<p class="is-style-eyebrow">Studio Field</p>
					<!-- /wp:paragraph -->
					<!-- wp:heading {"level":3} -->
					...
					<!-- /wp:paragraph -->
					<!-- wp:paragraph -->
					<p>Brand and product design for editorial and SaaS clients.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group is-style-card-bordered" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
					<!-- wp:paragraph {"className":"is-style-eyebrow"} -->
					<p class="is-style-eyebrow">Foundry Co.</p>
					<!-- /wp:paragraph -->
					<!-- wp:heading {"level":3} -->
					...
					<!-- /wp:paragraph -->
					<!-- wp:paragraph -->
					<p>Identity and web work for early-stage companies.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
