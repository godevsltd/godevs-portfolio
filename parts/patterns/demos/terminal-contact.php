<?php
/**
 * Title: Demo — Terminal (Contact)
 * Slug: godevs-portfolio/demo-terminal-contact
 * Description: Contact page for the Terminal demo. Split form + info layout with optional FAQ. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, terminal, contact, form, email, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@terminal.studio">hello@terminal.studio</a></p>
<!-- /wp:paragraph -->
