<?php
/**
 * Title: Demo — Speaker (Work)
 * Slug: godevs-portfolio/demo-speaker-work
 * Description: Work page for the Speaker demo. 2-column portfolio grid with selected projects. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, speaker, work, portfolio, grid, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
