<?php
/**
 * Title: Demo — Obscura (Work)
 * Slug: godevs-portfolio/demo-obscura-work
 * Description: Work page for the Obscura demo. 2-column portfolio grid with selected projects. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, obscura, work, portfolio, grid, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
