<?php
/**
 * Title: Demo — Terminal (DevOps)
 * Slug: godevs-portfolio/demo-terminal
 * Description: DevOps engineer portfolio. Terminal aesthetic, large numerical stats, split CTA. Recommended style variation: Dark.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, developer,, devops
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-terminal godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-demo-terminal alignfull">
        ...
        <div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--90);padding-bottom:var(--wp--preset--spacing--90)">
                ...
                <div class="wp-block-columns are-vertically-aligned-bottom">
                        ...
                        <div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:50%">
                                ...
                                <h2 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(5rem, 14vw, 12rem);line-height:0.9;letter-spacing:-0.04em;font-weight:700">80+</h2>
                                <!-- /wp:heading -->
                                <!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|medium"},"color":{"text":"var:preset|color|muted"}}} -->
                                <p style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--medium)">Sites shipped.</p>
                                <!-- /wp:paragraph -->
                        </div>
                        <!-- /wp:column -->
                        <!-- wp:column {"verticalAlignment":"bottom","width":"50%"} -->
                        <div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:50%">
                                ...
                                <!-- /wp:paragraph -->
                                <!-- wp:heading {"level":2,"style":{"typography":{"fontFamily":"var:preset|font-family|display","fontSize":"clamp(5rem, 14vw, 12rem)","lineHeight":"0.9","letterSpacing":"-0.04em","fontWeight":"700"}}} -->
                                <h2 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(5rem, 14vw, 12rem);line-height:0.9;letter-spacing:-0.04em;font-weight:700">12</h2>
                                <!-- /wp:heading -->
                                <!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|medium"},"color":{"text":"var:preset|color|muted"}}} -->
                                <p style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--medium)">Years of practice.</p>
                                <!-- /wp:paragraph -->
                        </div>
                        <!-- /wp:column -->
                </div>
