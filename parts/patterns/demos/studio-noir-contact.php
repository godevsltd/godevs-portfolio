<?php
/**
 * Title: Demo — Studio Noir (Contact)
 * Slug: godevs-portfolio/demo-studio-noir-contact
 * Description: Contact page for the Studio Noir demo. Split form + info layout with optional FAQ. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, studio-noir, contact, form, email, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@studio-noir.studio">hello@studio-noir.studio</a></p>
<!-- /wp:paragraph -->
