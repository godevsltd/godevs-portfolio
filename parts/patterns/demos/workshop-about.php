<?php
/**
 * Title: Demo — Workshop (About)
 * Slug: godevs-portfolio/demo-workshop-about
 * Description: About page for the Workshop demo. Bio intro, practice areas, and a closing CTA. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, workshop, about, bio, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Workshop is an independent practice working at the intersection of design and engineering.</p>
<!-- /wp:paragraph -->
