<?php
/**
 * Title: Demo — Pill (Case Studies)
 * Slug: godevs-portfolio/demo-pill-case-studies
 * Description: Case studies page for the Pill demo. Three case-study preview cards with result metrics. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, pill, case studies, results, metrics, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
