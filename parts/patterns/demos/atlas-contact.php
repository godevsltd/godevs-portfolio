<?php
/**
 * Title: Demo — Atlas (Contact)
 * Slug: godevs-portfolio/demo-atlas-contact
 * Description: Contact page for the Atlas demo. Split form + info layout with optional FAQ. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, atlas, contact, form, email, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@atlas.studio">hello@atlas.studio</a></p>
<!-- /wp:paragraph -->
