<?php
/**
 * Title: Demo — Concise (Contact)
 * Slug: godevs-portfolio/demo-concise-contact
 * Description: Contact page for the Concise demo. Split form + info layout with optional FAQ. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, concise, contact, form, email, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@concise.studio">hello@concise.studio</a></p>
<!-- /wp:paragraph -->
