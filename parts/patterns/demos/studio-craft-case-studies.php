<?php
/**
 * Title: Demo — Studio Craft (Case Studies)
 * Slug: godevs-portfolio/demo-studio-craft-case-studies
 * Description: Case studies page for the Studio Craft demo. Three case-study preview cards with result metrics. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, studio-craft, case studies, results, metrics, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
