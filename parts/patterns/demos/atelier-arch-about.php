<?php
/**
 * Title: Demo — Atelier Arch (About)
 * Slug: godevs-portfolio/demo-atelier-arch-about
 * Description: About page for the Atelier Arch demo. Bio intro, practice areas, and a closing CTA. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, atelier-arch, about, bio, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Atelier Arch is an architecture and design practice focused on considered, context-aware work.</p>
<!-- /wp:paragraph -->
