<?php
/**
 * Title: Demo — Teacher (Teaching)
 * Slug: godevs-portfolio/demo-teacher-teaching
 * Description: Teaching page for the Teacher demo. Courses and programs framed as a services-style composition. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, teacher, teaching, courses, programs, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
