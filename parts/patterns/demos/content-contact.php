<?php
/**
 * Title: Demo — Content (Contact)
 * Slug: godevs-portfolio/demo-content-contact
 * Description: Contact page for the Content demo. Split form + info layout with optional FAQ. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, content, contact, form, email, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@content.studio">hello@content.studio</a></p>
<!-- /wp:paragraph -->
