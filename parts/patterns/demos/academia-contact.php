<?php
/**
 * Title: Demo — Academia (Contact)
 * Slug: godevs-portfolio/demo-academia-contact
 * Description: Contact page for the Academia demo. Split form + info layout with optional FAQ. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, academia, contact, form, email, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@academia.studio">hello@academia.studio</a></p>
<!-- /wp:paragraph -->
