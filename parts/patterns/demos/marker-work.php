<?php
/**
 * Title: Demo — Marker (Work)
 * Slug: godevs-portfolio/demo-marker-work
 * Description: Work page for the Marker demo. 2-column portfolio grid with selected projects. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, marker, work, portfolio, grid, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
