<?php
/**
 * Title: Demo — Edifice (Work)
 * Slug: godevs-portfolio/demo-edifice-work
 * Description: Work page for the Edifice demo. 2-column portfolio grid with selected projects. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, edifice, work, portfolio, grid, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
