<?php
/**
 * Title: Demo — Course (About)
 * Slug: godevs-portfolio/demo-course-about
 * Description: About page for the Course demo. Bio intro, practice areas, and a closing CTA. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, course, about, bio, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Course is an academic practice spanning research, teaching, and writing.</p>
<!-- /wp:paragraph -->
