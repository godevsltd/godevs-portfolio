<?php
/**
 * Title: Demo — Professional (Work)
 * Slug: godevs-portfolio/demo-professional-work
 * Description: Work page for the Professional demo. 2-column portfolio grid with selected projects. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, professional, work, portfolio, grid, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
