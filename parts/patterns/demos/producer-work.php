<?php
/**
 * Title: Demo — Producer (Work)
 * Slug: godevs-portfolio/demo-producer-work
 * Description: Work page for the Producer demo. 2-column portfolio grid with selected projects. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, producer, work, portfolio, grid, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
