<?php
/**
 * Title: Demo — Keystone Pro (Contact)
 * Slug: godevs-portfolio/demo-keystone-pro-contact
 * Description: Contact page for the Keystone Pro demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, keystone-pro, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@keystone-pro.studio">hello@keystone-pro.studio</a></p>
<!-- /wp:paragraph -->
