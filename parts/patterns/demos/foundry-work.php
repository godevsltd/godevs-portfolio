<?php
/**
 * Title: Demo — Foundry (Work)
 * Slug: godevs-portfolio/demo-foundry-work
 * Description: Work page for the Foundry demo. 2-column portfolio grid with selected projects. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, foundry, work, portfolio, grid, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
