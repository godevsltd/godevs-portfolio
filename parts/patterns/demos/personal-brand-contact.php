<?php
/**
 * Title: Demo — Personal Brand (Contact)
 * Slug: godevs-portfolio/demo-personal-brand-contact
 * Description: Contact page for the Personal Brand demo. Split form + info layout with optional FAQ. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, personal-brand, contact, form, email, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
