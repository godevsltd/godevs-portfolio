<?php
/**
 * Title: Demo — Writer (Work)
 * Slug: godevs-portfolio/demo-writer-work
 * Description: Work page for the Writer demo. 2-column portfolio grid with selected projects. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, writer, work, portfolio, grid, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
