<?php
/**
 * Title: Demo — Inkwell (Contact)
 * Slug: godevs-portfolio/demo-inkwell-contact
 * Description: Contact page for the Inkwell demo. Split form + info layout with optional FAQ. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, inkwell, contact, form, email, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@inkwell.studio">hello@inkwell.studio</a></p>
<!-- /wp:paragraph -->
