<?php
/**
 * Title: Demo — Lifestyle (About)
 * Slug: godevs-portfolio/demo-lifestyle-about
 * Description: About page for the Lifestyle demo. Bio intro, practice areas, and a closing CTA. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, lifestyle, about, bio, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Lifestyle is a creative practice documenting and designing for considered living.</p>
<!-- /wp:paragraph -->
