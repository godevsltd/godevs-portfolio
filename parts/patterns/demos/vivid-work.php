<?php
/**
 * Title: Demo — Vivid (Work)
 * Slug: godevs-portfolio/demo-vivid-work
 * Description: Work page for the Vivid demo. 4-column portfolio grid with selected projects. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, vivid, work, portfolio, grid, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
