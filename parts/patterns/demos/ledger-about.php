<?php
/**
 * Title: Demo — Ledger (About)
 * Slug: godevs-portfolio/demo-ledger-about
 * Description: About page for the Ledger demo. Bio intro, practice areas, and a closing CTA. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, ledger, about, bio, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Ledger is a consulting practice helping teams make better decisions about their products and processes.</p>
<!-- /wp:paragraph -->
