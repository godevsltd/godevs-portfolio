<?php
/**
 * Title: Demo — Edifice (About)
 * Slug: godevs-portfolio/demo-edifice-about
 * Description: About page for the Edifice demo. Bio intro, practice areas, and a closing CTA. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, edifice, about, bio, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Edifice is a photography practice working across editorial, product, and portrait commissions.</p>
<!-- /wp:paragraph -->
