<?php
/**
 * Title: Contact — Contact Centered (Agency)
 * Slug: godevs-portfolio/contact-contact-centered-default-agency-1
 * Description: A contact centered contact section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-contact
 * Keywords: contact, contact centered, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
