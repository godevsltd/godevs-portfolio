<?php
/**
 * Title: Services — Three Column Cards (Designer)
 * Slug: godevs-portfolio/services-services-cards-surface-designer-1
 * Description: A three column cards services section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, three column cards, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
