<?php
/**
 * Title: Services — Three Column Cards (Architect)
 * Slug: godevs-portfolio/services-services-cards-default-architect-1
 * Description: A three column cards services section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, three column cards, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
