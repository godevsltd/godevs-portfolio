<?php
/**
 * Title: Services — Three Column Cards (Agency)
 * Slug: godevs-portfolio/services-services-cards-default-agency-1
 * Description: A three column cards services section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, three column cards, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
