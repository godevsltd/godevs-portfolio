<?php
/**
 * Title: Services — Three Column Cards (Developer)
 * Slug: godevs-portfolio/services-services-cards-surface-developer-1
 * Description: A three column cards services section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, three column cards, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
