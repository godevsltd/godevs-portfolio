<?php
/**
 * Title: Services — Numbered Cards (Consultant)
 * Slug: godevs-portfolio/services-services-numbered-surface-consultant-1
 * Description: A numbered cards services section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, numbered cards, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Market analysis, positioning, competitive framework.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3,"style":{"typography":{"fontFamily":"var:preset|font-family|display","fontWeight":"600"}}} -->
<h3 class="wp-block-heading">Messaging & Narrative</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Value proposition, messaging architecture, story.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3,"style":{"typography":{"fontFamily":"var:preset|font-family|display","fontWeight":"600"}}} -->
<h3 class="wp-block-heading">Organizational Design</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Team structure, roles, and process design.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
