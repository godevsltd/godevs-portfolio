<?php
/**
 * Title: Services — Numbered Cards (Freelancer)
 * Slug: godevs-portfolio/services-services-numbered-default-freelancer-1
 * Description: A numbered cards services section with freelancer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, numbered cards, freelancer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Identity, layout, and editorial design.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Block themes, patterns, and performance.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Ongoing care, updates, and hosting.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
