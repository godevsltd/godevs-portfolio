<?php
/**
 * Title: Services — Numbered Cards (Writer)
 * Slug: godevs-portfolio/services-services-numbered-surface-writer-1
 * Description: A numbered cards services section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, numbered cards, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<h3 class="wp-block-heading">Editorial Writing</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Essays, reviews, and long-form articles.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Brand voice, website copy, and product copy.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Manuscript editing and developmental editing.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
