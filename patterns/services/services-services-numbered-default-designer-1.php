<?php
/**
 * Title: Services — Numbered Cards (Designer)
 * Slug: godevs-portfolio/services-services-numbered-default-designer-1
 * Description: A numbered cards services section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, numbered cards, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">Design Systems</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Token-driven systems in Figma and code.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Long-form layouts, magazine systems, publications.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
