<?php
/**
 * Title: Services — Three Column Cards (Consultant)
 * Slug: godevs-portfolio/services-services-cards-default-consultant-1
 * Description: A three column cards services section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, three column cards, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
