<?php
/**
 * Title: Services — Numbered Cards (Photographer)
 * Slug: godevs-portfolio/services-services-numbered-surface-photographer-1
 * Description: A numbered cards services section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, numbered cards, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- wp:group {"className":"is-style-card-bordered","style":{"spacing":{"blockGap":"var:preset|spacing|30","padding":{"top":"var:preset|spacing|50","right":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|50"}}},"layout":{"type":"flex","orientation":"vertical","flexWrap":"nowrap"}} -->
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">Editorial Photography</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Magazine and publication photography.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">Portrait Sessions</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Studio and location portraiture.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">Commercial Work</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Brand and product photography.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
