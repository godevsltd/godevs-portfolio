<?php
/**
 * Title: Services — Feature List (Agency)
 * Slug: godevs-portfolio/services-services-list-default-agency-1
 * Description: A feature list services section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, feature list, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
