<?php
/**
 * Title: Services — Three Column Cards (Photographer)
 * Slug: godevs-portfolio/services-services-cards-surface-photographer-1
 * Description: A three column cards services section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, three column cards, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
