<?php
/**
 * Title: Services — Feature List (Designer)
 * Slug: godevs-portfolio/services-services-list-surface-designer-1
 * Description: A feature list services section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, feature list, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<h3 class="wp-block-heading" style="font-size:var(--wp--preset--font-size--medium);width:220px">Brand Identity</h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"color":{"text":"var:preset|color|muted"}}} -->
<p style="color:var(--wp--preset--color--muted)">Logo systems, typography pairings, color systems.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}},"border":{"top":{"color":"var:preset|color|border","width":"1px"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"var:preset|font-size|medium","fontFamily":"var:preset|font-family|display","fontWeight":"600"}}} -->
<h3 class="wp-block-heading" style="font-size:var(--wp--preset--font-size--medium);width:220px">Design Systems</h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"color":{"text":"var:preset|color|muted"}}} -->
<p style="color:var(--wp--preset--color--muted)">Token-driven systems in Figma and code.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"var:preset|font-size|medium","fontFamily":"var:preset|font-family|display","fontWeight":"600"}}} -->
<h3 class="wp-block-heading" style="font-size:var(--wp--preset--font-size--medium);width:220px">Editorial Design</h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"color":{"text":"var:preset|color|muted"}}} -->
<p style="color:var(--wp--preset--color--muted)">Long-form layouts, magazine systems, publications.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
