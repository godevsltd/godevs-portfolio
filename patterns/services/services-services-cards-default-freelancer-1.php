<?php
/**
 * Title: Services — Three Column Cards (Freelancer)
 * Slug: godevs-portfolio/services-services-cards-default-freelancer-1
 * Description: A three column cards services section with freelancer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, three column cards, freelancer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
