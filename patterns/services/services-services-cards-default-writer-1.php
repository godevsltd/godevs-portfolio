<?php
/**
 * Title: Services — Three Column Cards (Writer)
 * Slug: godevs-portfolio/services-services-cards-default-writer-1
 * Description: A three column cards services section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, three column cards, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
