<?php
/**
 * Title: Services — Numbered Cards (Developer)
 * Slug: godevs-portfolio/services-services-numbered-surface-developer-1
 * Description: A numbered cards services section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, numbered cards, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">API Design</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>REST and GraphQL APIs with clear contracts.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>CSS architecture, performance, accessibility.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>CI/CD, monitoring, deployment automation.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
