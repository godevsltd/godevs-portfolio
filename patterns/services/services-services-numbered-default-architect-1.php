<?php
/**
 * Title: Services — Numbered Cards (Architect)
 * Slug: godevs-portfolio/services-services-numbered-default-architect-1
 * Description: A numbered cards services section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-services
 * Keywords: services, numbered cards, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">Residential Design</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Single-family and multi-unit residential.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">Commercial Architecture</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Retail, office, and hospitality projects.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Master planning and public space design.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
