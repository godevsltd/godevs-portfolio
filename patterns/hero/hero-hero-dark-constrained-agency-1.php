<?php
/**
 * Title: Hero — Dark Creative (Agency)
 * Slug: godevs-portfolio/hero-hero-dark-constrained-agency-1
 * Description: A dark creative hero section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, dark creative, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<div class="wp-block-button is-style-outline"><a href="#work" class="wp-block-button__link wp-element-button">Start a project</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
