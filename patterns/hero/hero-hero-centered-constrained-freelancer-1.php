<?php
/**
 * Title: Hero — Centered Display (Freelancer)
 * Slug: godevs-portfolio/hero-hero-centered-constrained-freelancer-1
 * Description: A centered display hero section with freelancer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, centered display, freelancer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p class="is-style-eyebrow has-text-align-center">Freelance Designer & Developer</p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading has-text-align-center" style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size--xxx-large);line-height:1.05;letter-spacing:-0.02em">Available for select projects and collaborations.</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"var:preset|font-size|medium"},"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--medium);margin-top:var(--wp--preset--spacing--40)">I work with founders and small teams to ship portfolio, product, and publication sites.</p>
<!-- /wp:paragraph -->
