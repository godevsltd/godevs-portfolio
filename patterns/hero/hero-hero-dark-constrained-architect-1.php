<?php
/**
 * Title: Hero — Dark Creative (Architect)
 * Slug: godevs-portfolio/hero-hero-dark-constrained-architect-1
 * Description: A dark creative hero section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, dark creative, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2.75rem, 8vw, 6rem);line-height:1;letter-spacing:-0.025em;font-weight:700">Designing spaces that last.</h1>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-outline"><a href="#work" class="wp-block-button__link wp-element-button">View projects</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
