<?php
/**
 * Title: Hero — Dark Creative (Developer)
 * Slug: godevs-portfolio/hero-hero-dark-constrained-developer-1
 * Description: A dark creative hero section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, dark creative, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
