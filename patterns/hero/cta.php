 ...
 * Description: A short, single-purpose hero focused on a clear call-to-action. Headline, supporting line, and a prominent button group. For product launches, waitlists, and event pages.
 * Categories: godevs-portfolio-hero, godevs-portfolio-pages
 * Keywords: hero, cta, call-to-action, conversion, focused
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-hero-cta godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-hero-cta alignfull">
	...
	<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
		...
		<p class="is-style-eyebrow has-text-align-center">Available for new work — 2024</p>
		<!-- /wp:paragraph -->
		...
		<h1 class="wp-block-heading has-text-align-center" style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size--xx-large);line-height:1.1;letter-spacing:-0.02em">Let's build something worth visiting.</h1>
		<!-- /wp:heading -->
		<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"var:preset|font-size|medium"}}} -->
		<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--medium)">I'm currently taking on two new engagements for Q3 — portfolio sites, product launches, and editorial work.</p>
		<!-- /wp:paragraph -->
