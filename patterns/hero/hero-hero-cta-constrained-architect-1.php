<?php
/**
 * Title: Hero — CTA Focused (Architect)
 * Slug: godevs-portfolio/hero-hero-cta-constrained-architect-1
 * Description: A cta focused hero section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, cta focused, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<h1 class="wp-block-heading has-text-align-center" style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size--xx-large);line-height:1.1;letter-spacing:-0.02em">Designing spaces that last.</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"var:preset|font-size|medium"}}} -->
<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--medium)">Residential, commercial, and public architecture — each project grounded in site and material.</p>
<!-- /wp:paragraph -->
...
<!-- wp:button -->
<div class="wp-block-button"><a href="#contact" class="wp-block-button__link wp-element-button">View projects</a></div>
<!-- /wp:button -->
