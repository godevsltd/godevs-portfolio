<?php
/**
 * Title: Hero — Split Profile (Agency)
 * Slug: godevs-portfolio/hero-hero-split-default-agency-1
 * Description: A split profile hero section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, split profile, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
