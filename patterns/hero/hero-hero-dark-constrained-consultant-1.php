<?php
/**
 * Title: Hero — Dark Creative (Consultant)
 * Slug: godevs-portfolio/hero-hero-dark-constrained-consultant-1
 * Description: A dark creative hero section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, dark creative, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2.75rem, 8vw, 6rem);line-height:1;letter-spacing:-0.025em;font-weight:700">Helping growing teams create thoughtful strategy.</h1>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-outline"><a href="#work" class="wp-block-button__link wp-element-button">Book a consultation</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
