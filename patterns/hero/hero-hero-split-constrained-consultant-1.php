<?php
/**
 * Title: Hero — Split Profile (Consultant)
 * Slug: godevs-portfolio/hero-hero-split-constrained-consultant-1
 * Description: A split profile hero section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, split profile, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
