<?php
/**
 * Title: Hero — Split Profile (Architect)
 * Slug: godevs-portfolio/hero-hero-split-constrained-architect-1
 * Description: A split profile hero section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, split profile, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
