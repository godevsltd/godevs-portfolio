<?php
/**
 * Title: Hero — CTA Focused (Freelancer)
 * Slug: godevs-portfolio/hero-hero-cta-constrained-freelancer-1
 * Description: A cta focused hero section with freelancer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, cta focused, freelancer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<h1 class="wp-block-heading has-text-align-center" style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size--xx-large);line-height:1.1;letter-spacing:-0.02em">Available for select projects and collaborations.</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"var:preset|font-size|medium"}}} -->
<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--medium)">I work with founders and small teams to ship portfolio, product, and publication sites.</p>
<!-- /wp:paragraph -->
