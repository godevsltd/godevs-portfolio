<?php
/**
 * Title: Hero — CTA Focused (Developer)
 * Slug: godevs-portfolio/hero-hero-cta-constrained-developer-1
 * Description: A cta focused hero section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, cta focused, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<h1 class="wp-block-heading has-text-align-center" style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size--xx-large);line-height:1.1;letter-spacing:-0.02em">Building considered software that ships.</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"var:preset|font-size|medium"}}} -->
<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--medium)">A decade of full-stack engineering — from API design to deployment.</p>
<!-- /wp:paragraph -->
...
<!-- wp:button -->
<div class="wp-block-button"><a href="#contact" class="wp-block-button__link wp-element-button">See selected work</a></div>
<!-- /wp:button -->
