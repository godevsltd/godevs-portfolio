<?php
/**
 * Title: Hero — Dark Creative (Photographer)
 * Slug: godevs-portfolio/hero-hero-dark-constrained-photographer-1
 * Description: A dark creative hero section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, dark creative, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2.75rem, 8vw, 6rem);line-height:1;letter-spacing:-0.025em;font-weight:700">Long-form photography, slowly made.</h1>
<!-- /wp:heading -->
