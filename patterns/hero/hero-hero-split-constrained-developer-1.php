<?php
/**
 * Title: Hero — Split Profile (Developer)
 * Slug: godevs-portfolio/hero-hero-split-constrained-developer-1
 * Description: A split profile hero section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, split profile, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
