<?php
/**
 * Title: Hero — CTA Focused (Writer)
 * Slug: godevs-portfolio/hero-hero-cta-constrained-writer-1
 * Description: A cta focused hero section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, cta focused, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<h1 class="wp-block-heading has-text-align-center" style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size--xx-large);line-height:1.1;letter-spacing:-0.02em">Writing that holds up over time.</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"var:preset|font-size|medium"}}} -->
<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--medium)">Essays, articles, and editorial work on design, technology, and the practice of making things.</p>
<!-- /wp:paragraph -->
...
<!-- wp:button -->
<div class="wp-block-button"><a href="#contact" class="wp-block-button__link wp-element-button">Read the journal</a></div>
<!-- /wp:button -->
