<?php
/**
 * Title: Hero — Large Typography (Agency)
 * Slug: godevs-portfolio/hero-hero-large-type-constrained-agency-1
 * Description: A large typography hero section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, large typography, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(3rem, 9vw, 7.5rem);line-height:0.95;letter-spacing:-0.035em;font-weight:700">We design and build digital products with intent.</h1>
<!-- /wp:heading -->
