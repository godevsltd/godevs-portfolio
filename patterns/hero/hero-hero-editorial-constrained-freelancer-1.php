<?php
/**
 * Title: Hero — Editorial Typography (Freelancer)
 * Slug: godevs-portfolio/hero-hero-editorial-constrained-freelancer-1
 * Description: A editorial typography hero section with freelancer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, editorial typography, freelancer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2.75rem, 8vw, 6rem);line-height:1;letter-spacing:-0.025em;font-style:italic;font-weight:500">Available for select projects and collaborations.</h1>
<!-- /wp:heading -->
