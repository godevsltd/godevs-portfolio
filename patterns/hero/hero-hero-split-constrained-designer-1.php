<?php
/**
 * Title: Hero — Split Profile (Designer)
 * Slug: godevs-portfolio/hero-hero-split-constrained-designer-1
 * Description: A split profile hero section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-hero
 * Keywords: hero, split profile, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
