<?php
/**
 * Title: Contact — Contact Split (Writer)
 * Slug: godevs-portfolio/contact-contact-split-constrained-writer-1
 * Description: A contact split contact section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-contact
 * Keywords: contact, contact split, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
