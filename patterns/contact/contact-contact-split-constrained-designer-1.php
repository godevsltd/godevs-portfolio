<?php
/**
 * Title: Contact — Contact Split (Designer)
 * Slug: godevs-portfolio/contact-contact-split-constrained-designer-1
 * Description: A contact split contact section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-contact
 * Keywords: contact, contact split, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
