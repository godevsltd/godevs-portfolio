<?php
/**
 * Title: Contact — Contact Split (Architect)
 * Slug: godevs-portfolio/contact-contact-split-constrained-architect-1
 * Description: A contact split contact section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-contact
 * Keywords: contact, contact split, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
