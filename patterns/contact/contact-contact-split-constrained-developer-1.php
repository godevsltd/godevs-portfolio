<?php
/**
 * Title: Contact — Contact Split (Developer)
 * Slug: godevs-portfolio/contact-contact-split-constrained-developer-1
 * Description: A contact split contact section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-contact
 * Keywords: contact, contact split, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
