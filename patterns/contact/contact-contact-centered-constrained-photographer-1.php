<?php
/**
 * Title: Contact — Contact Centered (Photographer)
 * Slug: godevs-portfolio/contact-contact-centered-constrained-photographer-1
 * Description: A contact centered contact section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-contact
 * Keywords: contact, contact centered, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--large)"><a href="mailto:hello@example.com">hello@example.com</a></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
