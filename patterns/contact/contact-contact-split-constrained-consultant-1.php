<?php
/**
 * Title: Contact — Contact Split (Consultant)
 * Slug: godevs-portfolio/contact-contact-split-constrained-consultant-1
 * Description: A contact split contact section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-contact
 * Keywords: contact, contact split, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
