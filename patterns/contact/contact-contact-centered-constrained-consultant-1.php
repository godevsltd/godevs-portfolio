<?php
/**
 * Title: Contact — Contact Centered (Consultant)
 * Slug: godevs-portfolio/contact-contact-centered-constrained-consultant-1
 * Description: A contact centered contact section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-contact
 * Keywords: contact, contact centered, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
