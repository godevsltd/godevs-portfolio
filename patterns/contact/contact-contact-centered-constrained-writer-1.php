<?php
/**
 * Title: Contact — Contact Centered (Writer)
 * Slug: godevs-portfolio/contact-contact-centered-constrained-writer-1
 * Description: A contact centered contact section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-contact
 * Keywords: contact, contact centered, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
