<?php
/**
 * Title: Contact — Contact Centered (Developer)
 * Slug: godevs-portfolio/contact-contact-centered-constrained-developer-1
 * Description: A contact centered contact section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-contact
 * Keywords: contact, contact centered, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
