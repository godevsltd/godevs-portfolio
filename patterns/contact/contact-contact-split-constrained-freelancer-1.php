<?php
/**
 * Title: Contact — Contact Split (Freelancer)
 * Slug: godevs-portfolio/contact-contact-split-constrained-freelancer-1
 * Description: A contact split contact section with freelancer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-contact
 * Keywords: contact, contact split, freelancer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
