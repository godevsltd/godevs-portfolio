<?php
/**
 * Title: Contact — Contact Split (Photographer)
 * Slug: godevs-portfolio/contact-contact-split-constrained-photographer-1
 * Description: A contact split contact section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-contact
 * Keywords: contact, contact split, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<h2 class="wp-block-heading" style="font-size:var(--wp--preset--font-size--x-large);line-height:1.15">Let us talk.</h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p>Drop a short note below. I will reply within two working days.</p>
<!-- /wp:paragraph -->
<!-- wp:search {"label":"Message","showLabel":false,"placeholder":"Your message","buttonText":"Send","buttonPosition":"button-inside","buttonUseIcon":false,"style":{"border":{"radius":"4px"}}} /-->
</div>
<!-- /wp:group -->
</div>
<!-- /wp:column -->
