<?php
/**
 * Title: Contact — Contact Centered (Architect)
 * Slug: godevs-portfolio/contact-contact-centered-constrained-architect-1
 * Description: A contact centered contact section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-contact
 * Keywords: contact, contact centered, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
