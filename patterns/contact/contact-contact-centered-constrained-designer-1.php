<?php
/**
 * Title: Contact — Contact Centered (Designer)
 * Slug: godevs-portfolio/contact-contact-centered-constrained-designer-1
 * Description: A contact centered contact section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-contact
 * Keywords: contact, contact centered, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
