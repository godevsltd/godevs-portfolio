<?php
/**
 * Title: Education — Education Timeline (Developer)
 * Slug: godevs-portfolio/education-education-timeline-constrained-developer-1
 * Description: A education timeline education section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-education
 * Keywords: education, education timeline, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
