<?php
/**
 * Title: Education — Education Timeline (Photographer)
 * Slug: godevs-portfolio/education-education-timeline-constrained-photographer-1
 * Description: A education timeline education section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-education
 * Keywords: education, education timeline, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
