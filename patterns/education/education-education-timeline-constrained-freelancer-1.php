<?php
/**
 * Title: Education — Education Timeline (Freelancer)
 * Slug: godevs-portfolio/education-education-timeline-constrained-freelancer-1
 * Description: A education timeline education section with freelancer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-education
 * Keywords: education, education timeline, freelancer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
