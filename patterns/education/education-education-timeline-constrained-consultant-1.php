<?php
/**
 * Title: Education — Education Timeline (Consultant)
 * Slug: godevs-portfolio/education-education-timeline-constrained-consultant-1
 * Description: A education timeline education section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-education
 * Keywords: education, education timeline, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
