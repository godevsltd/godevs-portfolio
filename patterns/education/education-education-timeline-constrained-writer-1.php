<?php
/**
 * Title: Education — Education Timeline (Writer)
 * Slug: godevs-portfolio/education-education-timeline-constrained-writer-1
 * Description: A education timeline education section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-education
 * Keywords: education, education timeline, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
