<?php
/**
 * Title: Education — Education Timeline (Designer)
 * Slug: godevs-portfolio/education-education-timeline-constrained-designer-1
 * Description: A education timeline education section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-education
 * Keywords: education, education timeline, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
