<?php
/**
 * Title: Education — Education Timeline (Architect)
 * Slug: godevs-portfolio/education-education-timeline-constrained-architect-1
 * Description: A education timeline education section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-education
 * Keywords: education, education timeline, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
