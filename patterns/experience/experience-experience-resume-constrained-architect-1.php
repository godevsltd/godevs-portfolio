<?php
/**
 * Title: Experience — Resume Style (Architect)
 * Slug: godevs-portfolio/experience-experience-resume-constrained-architect-1
 * Description: A resume style experience section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-experience
 * Keywords: experience, resume style, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"color":{"text":"var:preset|color|muted"},"typography":{"fontSize":"var:preset|font-size|small"}}} -->
<p style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small)">2012 — 2018</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
<!-- wp:paragraph -->
