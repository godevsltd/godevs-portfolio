<?php
/**
 * Title: Experience — Vertical Timeline (Consultant)
 * Slug: godevs-portfolio/experience-experience-timeline-constrained-consultant-1
 * Description: A vertical timeline experience section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-experience
 * Keywords: experience, vertical timeline, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Where I have worked.</h2>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
...
<p style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small);width:180px">2018 — Now</p>
<!-- /wp:paragraph -->
...
<h3 class="wp-block-heading" style="font-size:var(--wp--preset--font-size--large)">Independent Consultant</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Strategy consulting for growing teams.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"color":{"text":"var:preset|color|muted"}}} -->
<p style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small);width:180px">2013 — 2018</p>
<!-- /wp:paragraph -->
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"},"padding":{"left":"var:preset|spacing|70"}},"layout":{"type":"flex","orientation":"vertical","flexWrap":"nowrap"}} -->
<div class="wp-block-group" style="padding-left:var(--wp--preset--spacing--70)">
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"var:preset|font-size|large"}}} -->
<h3 class="wp-block-heading" style="font-size:var(--wp--preset--font-size--large)">Director of Strategy · Signal Group</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Led strategy practice for B2B clients.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
