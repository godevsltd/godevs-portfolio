<?php
/**
 * Title: Experience — Vertical Timeline (Developer)
 * Slug: godevs-portfolio/experience-experience-timeline-constrained-developer-1
 * Description: A vertical timeline experience section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-experience
 * Keywords: experience, vertical timeline, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Working with founders on product and publication sites.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<div class="wp-block-group" style="padding-left:var(--wp--preset--spacing--70)">
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"var:preset|font-size|large"}}} -->
<h3 class="wp-block-heading" style="font-size:var(--wp--preset--font-size--large)">Senior Engineer · Studio Field</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Led engineering for editorial and SaaS clients.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
