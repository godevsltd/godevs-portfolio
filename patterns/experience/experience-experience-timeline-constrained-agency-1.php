<?php
/**
 * Title: Experience — Vertical Timeline (Agency)
 * Slug: godevs-portfolio/experience-experience-timeline-constrained-agency-1
 * Description: A vertical timeline experience section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-experience
 * Keywords: experience, vertical timeline, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small);width:180px">2016 — Now</p>
<!-- /wp:paragraph -->
