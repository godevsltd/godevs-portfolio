<?php
/**
 * Title: Experience — Resume Style (Developer)
 * Slug: godevs-portfolio/experience-experience-resume-constrained-developer-1
 * Description: A resume style experience section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-experience
 * Keywords: experience, resume style, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
