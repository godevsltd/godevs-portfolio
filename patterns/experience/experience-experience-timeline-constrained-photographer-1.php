<?php
/**
 * Title: Experience — Vertical Timeline (Photographer)
 * Slug: godevs-portfolio/experience-experience-timeline-constrained-photographer-1
 * Description: A vertical timeline experience section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-experience
 * Keywords: experience, vertical timeline, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small);width:180px">2020 — Now</p>
<!-- /wp:paragraph -->
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Editorial and commercial photography.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"color":{"text":"var:preset|color|muted"}}} -->
<p style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small);width:180px">2016 — 2020</p>
<!-- /wp:paragraph -->
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"},"padding":{"left":"var:preset|spacing|70"}},"layout":{"type":"flex","orientation":"vertical","flexWrap":"nowrap"}} -->
<div class="wp-block-group" style="padding-left:var(--wp--preset--spacing--70)">
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"var:preset|font-size|large"}}} -->
<h3 class="wp-block-heading" style="font-size:var(--wp--preset--font-size--large)">Staff Photographer · Atlas Magazine</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Covered editorial and fashion assignments.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
