<?php
/**
 * Title: Experience — Vertical Timeline (Architect)
 * Slug: godevs-portfolio/experience-experience-timeline-default-architect-1
 * Description: A vertical timeline experience section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-experience
 * Keywords: experience, vertical timeline, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Residential and commercial architecture.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"color":{"text":"var:preset|color|muted"}}} -->
<p style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small);width:180px">2012 — 2018</p>
<!-- /wp:paragraph -->
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"},"padding":{"left":"var:preset|spacing|70"}},"layout":{"type":"flex","orientation":"vertical","flexWrap":"nowrap"}} -->
<div class="wp-block-group" style="padding-left:var(--wp--preset--spacing--70)">
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"var:preset|font-size|large"}}} -->
<h3 class="wp-block-heading" style="font-size:var(--wp--preset--font-size--large)">Associate · Edifice Studio</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Led residential and cultural projects.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
