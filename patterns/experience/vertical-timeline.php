 ...
 * Description: A vertical list of roles with year, title, organization, and a short summary, anchored by a section header.
 * Categories: godevs-portfolio-experience
 * Keywords: experience, timeline, work, history, résumé, roles
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-experience-vertical-timeline","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-experience-vertical-timeline alignfull">
	...
	<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-group" style="border-top-color:var(--wp--preset--color--border);border-top-width:1px;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"layout":{"selfStretch":"fit","flexSize":"180px"}},"color":{"text":"var:preset|color|muted"}} -->
			...
			<div class="wp-block-group" style="border-top-color:var(--wp--preset--color--border);border-top-width:1px;border-bottom-color:var(--wp--preset--color--border);border-bottom-width:1px;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
				...
				<div class="wp-block-group" style="padding-left:var(--wp--preset--spacing--70)">
					<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"var:preset|font-size|large"}}} -->
					<h3 class="wp-block-heading" style="font-size:var(--wp--preset--font-size--large)">Designer, Foundry Co.</h3>
					<!-- /wp:heading -->
					<!-- wp:paragraph -->
