<?php
/**
 * Title: About — Split with Portrait (Agency)
 * Slug: godevs-portfolio/about-about-split-surface-agency-1
 * Description: A split with portrait about section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-about
 * Keywords: about, split with portrait, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
