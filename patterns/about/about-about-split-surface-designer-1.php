<?php
/**
 * Title: About — Split with Portrait (Designer)
 * Slug: godevs-portfolio/about-about-split-surface-designer-1
 * Description: A split with portrait about section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-about
 * Keywords: about, split with portrait, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Designing thoughtful digital products.</h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
