<?php
/**
 * Title: About — Split with Portrait (Writer)
 * Slug: godevs-portfolio/about-about-split-default-writer-1
 * Description: A split with portrait about section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-about
 * Keywords: about, split with portrait, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Writing that holds up over time.</h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
