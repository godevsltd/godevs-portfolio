<?php
/**
 * Title: About — Split with Portrait (Developer)
 * Slug: godevs-portfolio/about-about-split-default-developer-1
 * Description: A split with portrait about section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-about
 * Keywords: about, split with portrait, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Building considered software that ships.</h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
