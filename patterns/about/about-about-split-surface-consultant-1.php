<?php
/**
 * Title: About — Split with Portrait (Consultant)
 * Slug: godevs-portfolio/about-about-split-surface-consultant-1
 * Description: A split with portrait about section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-about
 * Keywords: about, split with portrait, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Helping growing teams create thoughtful strategy.</h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
