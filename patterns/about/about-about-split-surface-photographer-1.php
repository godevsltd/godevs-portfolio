<?php
/**
 * Title: About — Split with Portrait (Photographer)
 * Slug: godevs-portfolio/about-about-split-surface-photographer-1
 * Description: A split with portrait about section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-about
 * Keywords: about, split with portrait, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Long-form photography, slowly made.</h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
