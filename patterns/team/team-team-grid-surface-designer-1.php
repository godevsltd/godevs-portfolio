<?php
/**
 * Title: Team — Team Grid (Designer)
 * Slug: godevs-portfolio/team-team-grid-surface-designer-1
 * Description: A team grid team section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-team
 * Keywords: team, team grid, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
