<?php
/**
 * Title: Team — Team Grid (Writer)
 * Slug: godevs-portfolio/team-team-grid-surface-writer-1
 * Description: A team grid team section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-team
 * Keywords: team, team grid, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
