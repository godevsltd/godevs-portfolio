<?php
/**
 * Title: Team — Team Grid (Consultant)
 * Slug: godevs-portfolio/team-team-grid-default-consultant-1
 * Description: A team grid team section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-team
 * Keywords: team, team grid, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
