<?php
/**
 * Title: Team — Team Grid (Photographer)
 * Slug: godevs-portfolio/team-team-grid-default-photographer-1
 * Description: A team grid team section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-team
 * Keywords: team, team grid, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
