<?php
/**
 * Title: Team — Team Grid (Agency)
 * Slug: godevs-portfolio/team-team-grid-default-agency-1
 * Description: A team grid team section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-team
 * Keywords: team, team grid, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
