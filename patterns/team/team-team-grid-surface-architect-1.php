<?php
/**
 * Title: Team — Team Grid (Architect)
 * Slug: godevs-portfolio/team-team-grid-surface-architect-1
 * Description: A team grid team section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-team
 * Keywords: team, team grid, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
