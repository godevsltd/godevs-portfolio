<?php
/**
 * Title: Portfolio — Three Column Grid (Agency)
 * Slug: godevs-portfolio/portfolio-portfolio-3col-default-agency-1
 * Description: A three column grid portfolio section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, three column grid, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
