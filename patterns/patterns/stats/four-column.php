 ...
 * Description: A four-column stat grid showing large numbers with labels below. Distinct in its quantitative four-up grid composition.
 * Categories: godevs-portfolio-stats
 * Keywords: stats, four-column, numbers, metrics, grid
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-stats-four-column godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-stats-four-column alignfull">
