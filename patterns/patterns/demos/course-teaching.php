<?php
/**
 * Title: Demo — Course (Teaching)
 * Slug: godevs-portfolio/demo-course-teaching
 * Description: Teaching page for the Course demo. Courses and programs framed as a services-style composition. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, course, teaching, courses, programs, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
