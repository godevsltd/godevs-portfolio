<?php
/**
 * Title: Demo — Fieldnotes (About)
 * Slug: godevs-portfolio/demo-fieldnotes-about
 * Description: About page for the Fieldnotes demo. Bio intro, practice areas, and a closing CTA. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, fieldnotes, about, bio, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Fieldnotes is a design practice focused on identity, editorial, and product work.</p>
<!-- /wp:paragraph -->
