<?php
/**
 * Title: Demo — Marker (About)
 * Slug: godevs-portfolio/demo-marker-about
 * Description: About page for the Marker demo. Bio intro, practice areas, and a closing CTA. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, marker, about, bio, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Marker is a design practice focused on identity, editorial, and product work.</p>
<!-- /wp:paragraph -->
