...
/**
 * Title: Demo — PM (Work)
 * Slug: godevs-portfolio/demo-pm-work
 * Description: Work page for the PM demo. 2-column portfolio grid with selected projects. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, pm, work, portfolio, grid, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
