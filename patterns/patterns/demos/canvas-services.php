<?php
/**
 * Title: Demo — Canvas (Services)
 * Slug: godevs-portfolio/demo-canvas-services
 * Description: Services page for the Canvas demo. Three-card service grid with process steps. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, canvas, services, pricing, designer
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2rem, 5vw, 3.5rem);line-height:1.1;letter-spacing:-0.025em;font-weight:600">What I design.</h1>
<!-- /wp:heading -->
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|medium);max-width:520px">Three areas of design practice, often combined into one engagement. Each is scoped in writing with clear deliverables.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</section>
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|small)">End-to-end product design — user flows, wireframes, high-fidelity prototypes, and the design handoff that makes engineering's job easier.</p>
<!-- /wp:paragraph -->
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|small);margin-top:var(--wp--preset--spacing--20)"><strong>Timeline:</strong> 8–12 weeks<br><strong>Deliverables:</strong> Flows, prototypes, design specs</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"color":{"text":"var:preset|color|muted"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|small)">Scalable component libraries, design tokens, and documentation that makes the system usable by other designers and engineers.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"spacing":{"margin":{"top":"var:preset|spacing|20"}},"color":{"text":"var:preset|color|muted"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|small);margin-top:var(--wp--preset--spacing--20)"><strong>Timeline:</strong> 4–8 weeks<br><strong>Deliverables:</strong> Tokens, components, docs</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"color":{"text":"var:preset|color|muted"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|small)">Visual identity — wordmarks, type pairings, color systems, and the guidelines that hold them together across every touchpoint.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"spacing":{"margin":{"top":"var:preset|spacing|20"}},"color":{"text":"var:preset|color|muted"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|small);margin-top:var(--wp--preset--spacing--20)"><strong>Timeline:</strong> 6–8 weeks<br><strong>Deliverables:</strong> Identity, guidelines, templates</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
