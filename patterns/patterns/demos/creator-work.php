<?php
/**
 * Title: Demo — Creator (Work)
 * Slug: godevs-portfolio/demo-creator-work
 * Description: Work page for the Creator demo. 3-column portfolio grid with selected projects. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, creator, work, portfolio, grid, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
