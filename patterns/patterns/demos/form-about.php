<?php
/**
 * Title: Demo — Form (About)
 * Slug: godevs-portfolio/demo-form-about
 * Description: About page for the Form demo. Bio intro, practice areas, and a closing CTA. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, form, about, bio, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Form is an architecture and design practice focused on considered, context-aware work.</p>
<!-- /wp:paragraph -->
