 ...
 * Description: Journal page for the Signature demo. Notes on personal branding. Uses the Elegant style variation.
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|medium);max-width:520px">Occasional writing on identity, voice, and what it means to build a brand around a person.</p>
<!-- /wp:paragraph -->
