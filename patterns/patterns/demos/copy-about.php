<?php
/**
 * Title: Demo — Copy (About)
 * Slug: godevs-portfolio/demo-copy-about
 * Description: About page for the Copy demo. Bio intro, practice areas, and a closing CTA. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, copy, about, bio, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Copy, a copywriter portfolio.</p>
<!-- /wp:paragraph -->
