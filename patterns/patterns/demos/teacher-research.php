<?php
/**
 * Title: Demo — Teacher (Research)
 * Slug: godevs-portfolio/demo-teacher-research
 * Description: Research page for the Teacher demo. Focus areas and publications framed as a stats/experience composition. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, teacher, research, publications, focus areas, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
