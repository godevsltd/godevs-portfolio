<?php
/**
 * Title: Demo — Central (Work)
 * Slug: godevs-portfolio/demo-central-work
 * Description: Work page for the Central demo. 3-column portfolio grid with selected projects. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, central, work, portfolio, grid, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
