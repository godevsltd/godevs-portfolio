<?php
/**
 * Title: Demo — Visage (About)
 * Slug: godevs-portfolio/demo-visage-about
 * Description: About page for the Visage demo. Bio intro, practice areas, and a closing CTA. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, visage, about, bio, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Visage is a photography practice working across editorial, product, and portrait commissions.</p>
<!-- /wp:paragraph -->
