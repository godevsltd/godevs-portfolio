<?php
/**
 * Title: Demo — Verdure (Contact)
 * Slug: godevs-portfolio/demo-verdure-contact
 * Description: Contact page for the Verdure demo. Split form + info layout with optional FAQ. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, verdure, contact, form, email, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@verdure.studio">hello@verdure.studio</a></p>
<!-- /wp:paragraph -->
