<?php
/**
 * Title: Demo — Solo Practice (Work)
 * Slug: godevs-portfolio/demo-solo-practice-work
 * Description: Work page for the Solo Practice demo. 2-column portfolio grid with selected projects. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, solo-practice, work, portfolio, grid, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
