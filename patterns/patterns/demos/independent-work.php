<?php
/**
 * Title: Demo — Independent (Work)
 * Slug: godevs-portfolio/demo-independent-work
 * Description: Work page for the Independent demo. 2-column portfolio grid with selected projects. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, independent, work, portfolio, grid, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
