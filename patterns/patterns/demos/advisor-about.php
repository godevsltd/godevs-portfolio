<?php
/**
 * Title: Demo — Advisor (About)
 * Slug: godevs-portfolio/demo-advisor-about
 * Description: About page for the Advisor demo. Bio intro, practice areas, and a closing CTA. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, advisor, about, bio, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Advisor is a consulting practice helping teams make better decisions about their products and processes.</p>
<!-- /wp:paragraph -->
