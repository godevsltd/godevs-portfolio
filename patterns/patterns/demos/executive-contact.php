<?php
/**
 * Title: Demo — Executive (Contact)
 * Slug: godevs-portfolio/demo-executive-contact
 * Description: Contact page for the Executive demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, executive, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@executive.studio">hello@executive.studio</a></p>
<!-- /wp:paragraph -->
