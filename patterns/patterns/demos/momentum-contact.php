<?php
/**
 * Title: Demo — Momentum (Contact)
 * Slug: godevs-portfolio/demo-momentum-contact
 * Description: Contact page for the Momentum demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, momentum, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@momentum.studio">hello@momentum.studio</a></p>
<!-- /wp:paragraph -->
