<?php
/**
 * Title: Demo — Codecraft (About)
 * Slug: godevs-portfolio/demo-codecraft-about
 * Description: About page for the Codecraft demo. Bio intro, practice areas, and a closing CTA. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, codecraft, about, bio, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Codecraft is an independent practice working at the intersection of design and engineering.</p>
<!-- /wp:paragraph -->
