<?php
/**
 * Title: Demo — Text Link (Contact)
 * Slug: godevs-portfolio/demo-text-link-contact
 * Description: Contact page for the Text Link demo. Split form + info layout with optional FAQ. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, text-link, contact, form, email, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@text-link.studio">hello@text-link.studio</a></p>
<!-- /wp:paragraph -->
