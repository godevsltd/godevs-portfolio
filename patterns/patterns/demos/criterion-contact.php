<?php
/**
 * Title: Demo — Criterion (Contact)
 * Slug: godevs-portfolio/demo-criterion-contact
 * Description: Contact page for the Criterion demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, criterion, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@criterion.studio">hello@criterion.studio</a></p>
<!-- /wp:paragraph -->
