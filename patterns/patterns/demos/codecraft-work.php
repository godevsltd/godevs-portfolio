<?php
/**
 * Title: Demo — Codecraft (Work)
 * Slug: godevs-portfolio/demo-codecraft-work
 * Description: Work page for the Codecraft demo. 3-column portfolio grid with selected projects. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, codecraft, work, portfolio, grid, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
