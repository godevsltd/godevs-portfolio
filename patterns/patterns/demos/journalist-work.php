<?php
/**
 * Title: Demo — Journalist (Work)
 * Slug: godevs-portfolio/demo-journalist-work
 * Description: Work page for the Journalist demo. 2-column portfolio grid with selected projects. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, journalist, work, portfolio, grid, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
