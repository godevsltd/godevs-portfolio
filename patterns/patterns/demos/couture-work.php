<?php
/**
 * Title: Demo — Couture (Work)
 * Slug: godevs-portfolio/demo-couture-work
 * Description: Work page for the Couture demo. 2-column portfolio grid with selected projects. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, couture, work, portfolio, grid, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
