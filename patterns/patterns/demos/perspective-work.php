<?php
/**
 * Title: Demo — Perspective (Work)
 * Slug: godevs-portfolio/demo-perspective-work
 * Description: Work page for the Perspective demo. 2-column portfolio grid with selected projects. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, perspective, work, portfolio, grid, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
