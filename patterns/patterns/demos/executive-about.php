<?php
/**
 * Title: Demo — Executive (About)
 * Slug: godevs-portfolio/demo-executive-about
 * Description: About page for the Executive demo. Bio intro, practice areas, and a closing CTA. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, executive, about, bio, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Executive, a executive portfolio.</p>
<!-- /wp:paragraph -->
