<?php
/**
 * Title: Demo — Northline (Contact)
 * Slug: godevs-portfolio/demo-northline-contact
 * Description: Contact page for the Northline demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, northline, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@northline.studio">hello@northline.studio</a></p>
<!-- /wp:paragraph -->
