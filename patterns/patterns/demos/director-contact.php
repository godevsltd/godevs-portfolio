<?php
/**
 * Title: Demo — Director (Contact)
 * Slug: godevs-portfolio/demo-director-contact
 * Description: Contact page for the Director demo. Dark cinematic contact with representation, festival, and press routing. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, director, contact, representation, festival, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<!-- ═══ HERO — Cinematic close on dark surface ═══ -->
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"textColor":"contrast","style":{"typography":{"fontFamily":"var:preset|font-family|display","fontSize":"clamp(2.25rem, 6vw, 4rem)","lineHeight":"1","letterSpacing":"-0.03em","fontWeight":"600"}}} -->
...
<p class="has-contrast-color has-text-color" style="color:var(--wp--preset--color--contrast);font-size:var(--wp--preset--font-size--medium);line-height:1.7;max-width:640px">Direct email is the fastest route for general inquiries. For representation, festival programming, and press, please use the routing listed below — it reaches the right person faster.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</section>
...
<!-- wp:paragraph {"align":"center","className":"is-style-eyebrow","style":{"typography":{"letterSpacing":"0.25em","textTransform":"uppercase"}}} -->
...
<p class="has-text-align-center has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--medium);line-height:1.7;max-width:560px">Reply within 2—3 business days. For urgent work, mark the subject line "TIME-SENSITIVE".</p>
<!-- /wp:paragraph -->
<!-- wp:separator {"className":"is-style-thin","style":{"spacing":{"margin":{"top":"var:preset|spacing|60"}}}} -->
<hr class="wp-block-separator has-alpha-channel-opacity is-style-thin" style="margin-top:var(--wp--preset--spacing--60)"/>
<!-- /wp:separator -->
</div>
<!-- /wp:group -->
</section>
...
<!-- ═══ ROUTING — Representation / Festival / Press ═══ -->
<!-- wp:group {"tagName":"section","layout":{"type":"default"}} -->
<section class="wp-block-group alignfull">
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small);line-height:1.7">Northbound Films<br>Berlin · London</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"}}} -->
<p style="font-size:var(--wp--preset--font-size--small)"><a href="mailto:lena@northboundfilms.de">lena@northboundfilms.de</a></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small","lineHeight":"1.7"},"color":{"text":"var:preset|color|muted"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small);line-height:1.7">For festival inquiries, screening requests, and retrospective programming. Please include exhibition format and dates.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"}}} -->
<p style="font-size:var(--wp--preset--font-size--small)"><a href="mailto:festival@vance.studio">festival@vance.studio</a></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small","lineHeight":"1.7"},"color":{"text":"var:preset|color|muted"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small);line-height:1.7">For interviews, profile pieces, and stills requests. Press kit and EPK available on request.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"}}} -->
<p style="font-size:var(--wp--preset--font-size--small)"><a href="mailto:press@vance.studio">press@vance.studio</a></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small","lineHeight":"1.7"},"color":{"text":"var:preset|color|muted"},"layout":{"selfStretch":"fit","flexSize":"520px"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small);line-height:1.7;max-width:520px">A short message is fine. Include the project, timeline, and intended format if you can.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-fill"><a href="#send" class="wp-block-button__link wp-element-button">Send message</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
...
<!-- ═══ STUDIO INFO — Centered footer-like block ═══ -->
<!-- wp:group {"tagName":"section","layout":{"type":"default"}} -->
<section class="wp-block-group alignfull">
...
<p class="has-text-align-center has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small)">Studio visits by request. Press kit and EPK available on request.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</section>
