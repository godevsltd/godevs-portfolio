<?php
/**
 * Title: Demo — Structural (Work)
 * Slug: godevs-portfolio/demo-structural-work
 * Description: Work page for the Structural demo. 2-column portfolio grid with selected projects. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, structural, work, portfolio, grid, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
