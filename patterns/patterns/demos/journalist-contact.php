<?php
/**
 * Title: Demo — Journalist (Contact)
 * Slug: godevs-portfolio/demo-journalist-contact
 * Description: Contact page for the Journalist demo. Split form + info layout with optional FAQ. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, journalist, contact, form, email, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@journalist.studio">hello@journalist.studio</a></p>
<!-- /wp:paragraph -->
