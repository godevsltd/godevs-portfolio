<?php
/**
 * Title: Demo — Creator (Contact)
 * Slug: godevs-portfolio/demo-creator-contact
 * Description: Contact page for the Creator demo. Split form + info layout with optional FAQ. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, creator, contact, form, email, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@creator.studio">hello@creator.studio</a></p>
<!-- /wp:paragraph -->
