<?php
/**
 * Title: Demo — Wander (Work)
 * Slug: godevs-portfolio/demo-wander-work
 * Description: Work page for the Wander demo. 4-column portfolio grid with selected projects. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, wander, work, portfolio, grid, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
