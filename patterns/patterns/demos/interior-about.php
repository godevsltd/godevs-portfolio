<?php
/**
 * Title: Demo — Interior (About)
 * Slug: godevs-portfolio/demo-interior-about
 * Description: About page for the Interior demo. Bio intro, practice areas, and a closing CTA. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, interior, about, bio, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Interior is an architecture and design practice focused on considered, context-aware work.</p>
<!-- /wp:paragraph -->
