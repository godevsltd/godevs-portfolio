<?php
/**
 * Title: Demo — Marker (Case Studies)
 * Slug: godevs-portfolio/demo-marker-case-studies
 * Description: Case studies page for the Marker demo. Three case-study preview cards with result metrics. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, marker, case studies, results, metrics, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
