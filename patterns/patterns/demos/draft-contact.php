<?php
/**
 * Title: Demo — Draft (Contact)
 * Slug: godevs-portfolio/demo-draft-contact
 * Description: Contact page for the Draft demo. Split form + info layout with optional FAQ. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, draft, contact, form, email, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@draft.studio">hello@draft.studio</a></p>
<!-- /wp:paragraph -->
