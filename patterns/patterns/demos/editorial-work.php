<?php
/**
 * Title: Demo — Editorial (Work)
 * Slug: godevs-portfolio/demo-editorial-work
 * Description: Work page for the Editorial demo. 2-column portfolio grid with selected projects. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, editorial, work, portfolio, grid, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
