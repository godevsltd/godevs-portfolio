<?php
/**
 * Title: Demo — Professor (Teaching)
 * Slug: godevs-portfolio/demo-professor-teaching
 * Description: Teaching page for the Professor demo. Courses and programs framed as a services-style composition. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, professor, teaching, courses, programs, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
