<?php
/**
 * Title: Demo — Research (Research)
 * Slug: godevs-portfolio/demo-research-research
 * Description: Research page for the Research demo. Focus areas and publications framed as a stats/experience composition. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, research, research, publications, focus areas, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
