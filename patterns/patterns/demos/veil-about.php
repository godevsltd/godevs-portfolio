<?php
/**
 * Title: Demo — Veil (About)
 * Slug: godevs-portfolio/demo-veil-about
 * Description: About page for the Veil demo. Bio intro, practice areas, and a closing CTA. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, veil, about, bio, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Veil is a photography practice working across editorial, product, and portrait commissions.</p>
<!-- /wp:paragraph -->
