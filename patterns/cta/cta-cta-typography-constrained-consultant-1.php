<?php
/**
 * Title: Cta — Typography CTA (Consultant)
 * Slug: godevs-portfolio/cta-cta-typography-constrained-consultant-1
 * Description: A typography cta cta section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, typography cta, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
