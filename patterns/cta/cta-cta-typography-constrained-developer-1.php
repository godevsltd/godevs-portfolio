<?php
/**
 * Title: Cta — Typography CTA (Developer)
 * Slug: godevs-portfolio/cta-cta-typography-constrained-developer-1
 * Description: A typography cta cta section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, typography cta, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
