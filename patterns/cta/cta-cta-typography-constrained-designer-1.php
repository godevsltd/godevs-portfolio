<?php
/**
 * Title: Cta — Typography CTA (Designer)
 * Slug: godevs-portfolio/cta-cta-typography-constrained-designer-1
 * Description: A typography cta cta section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, typography cta, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
