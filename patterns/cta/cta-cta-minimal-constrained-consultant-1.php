<?php
/**
 * Title: Cta — Minimal CTA (Consultant)
 * Slug: godevs-portfolio/cta-cta-minimal-constrained-consultant-1
 * Description: A minimal cta cta section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, minimal cta, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
