 ...
 * Description: An ultra-restrained CTA with just a single line of large display type and an inline text-link button below. Distinct in its sparse, gallery-like composition.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, minimal, restrained, sparse, inline
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-cta-minimal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-cta-minimal alignfull">
