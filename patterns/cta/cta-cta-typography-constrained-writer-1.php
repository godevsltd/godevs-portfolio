<?php
/**
 * Title: Cta — Typography CTA (Writer)
 * Slug: godevs-portfolio/cta-cta-typography-constrained-writer-1
 * Description: A typography cta cta section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, typography cta, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
