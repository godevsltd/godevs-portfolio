<?php
/**
 * Title: Cta — Typography CTA (Agency)
 * Slug: godevs-portfolio/cta-cta-typography-default-agency-1
 * Description: A typography cta cta section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, typography cta, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
