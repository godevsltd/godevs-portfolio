<?php
/**
 * Title: Cta — Minimal CTA (Agency)
 * Slug: godevs-portfolio/cta-cta-minimal-default-agency-1
 * Description: A minimal cta cta section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, minimal cta, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
