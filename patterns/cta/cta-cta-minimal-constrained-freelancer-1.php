<?php
/**
 * Title: Cta — Minimal CTA (Freelancer)
 * Slug: godevs-portfolio/cta-cta-minimal-constrained-freelancer-1
 * Description: A minimal cta cta section with freelancer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, minimal cta, freelancer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
