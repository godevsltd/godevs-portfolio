<?php
/**
 * Title: Cta — Minimal CTA (Photographer)
 * Slug: godevs-portfolio/cta-cta-minimal-constrained-photographer-1
 * Description: A minimal cta cta section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, minimal cta, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
