<?php
/**
 * Title: Cta — Typography CTA (Freelancer)
 * Slug: godevs-portfolio/cta-cta-typography-constrained-freelancer-1
 * Description: A typography cta cta section with freelancer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, typography cta, freelancer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
