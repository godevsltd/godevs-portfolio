<?php
/**
 * Title: Cta — Minimal CTA (Developer)
 * Slug: godevs-portfolio/cta-cta-minimal-constrained-developer-1
 * Description: A minimal cta cta section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, minimal cta, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
