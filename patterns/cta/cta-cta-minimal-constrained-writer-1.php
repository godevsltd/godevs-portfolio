<?php
/**
 * Title: Cta — Minimal CTA (Writer)
 * Slug: godevs-portfolio/cta-cta-minimal-constrained-writer-1
 * Description: A minimal cta cta section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, minimal cta, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
