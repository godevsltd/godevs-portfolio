<?php
/**
 * Title: Cta — Minimal CTA (Designer)
 * Slug: godevs-portfolio/cta-cta-minimal-constrained-designer-1
 * Description: A minimal cta cta section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, minimal cta, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
