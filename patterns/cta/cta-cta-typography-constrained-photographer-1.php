<?php
/**
 * Title: Cta — Typography CTA (Photographer)
 * Slug: godevs-portfolio/cta-cta-typography-constrained-photographer-1
 * Description: A typography cta cta section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, typography cta, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
