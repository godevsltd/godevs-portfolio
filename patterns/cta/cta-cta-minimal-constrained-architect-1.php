<?php
/**
 * Title: Cta — Minimal CTA (Architect)
 * Slug: godevs-portfolio/cta-cta-minimal-constrained-architect-1
 * Description: A minimal cta cta section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, minimal cta, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
