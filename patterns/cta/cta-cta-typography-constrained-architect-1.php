<?php
/**
 * Title: Cta — Typography CTA (Architect)
 * Slug: godevs-portfolio/cta-cta-typography-constrained-architect-1
 * Description: A typography cta cta section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-cta
 * Keywords: cta, typography cta, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
