...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-stats-minimal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-stats-minimal alignfull">
	<!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"},"blockGap":"var:preset|spacing|30"}},"layout":{"type":"constrained","contentSize":"640px"}} -->
