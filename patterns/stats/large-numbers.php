 ...
 * Description: A two-up stat display with oversized display numerals dominating the composition. Distinct in its large-format typographic emphasis.
 * Categories: godevs-portfolio-stats
 * Keywords: stats, large, numbers, display, oversized
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
		...
		<div class="wp-block-columns are-vertically-aligned-bottom">
			...
			<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:50%">
				...
				<div class="wp-block-group">
					...
					<p style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--medium)">Sites shipped — independent practice and studio years combined.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:50%">
				...
				<div class="wp-block-group">
					...
					<!-- /wp:heading -->
					<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|medium"},"color":{"text":"var:preset|color|muted"}}} -->
					<p style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--medium)">Years of practice across three studios and an independent practice.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
