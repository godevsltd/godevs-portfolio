<?php
/**
 * Title: Portfolio — Two Column Large (Developer)
 * Slug: godevs-portfolio/portfolio-portfolio-2col-surface-developer-1
 * Description: A two column large portfolio section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, two column large, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
