<?php
/**
 * Title: Portfolio — Three Column Grid (Photographer)
 * Slug: godevs-portfolio/portfolio-portfolio-3col-default-photographer-1
 * Description: A three column grid portfolio section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, three column grid, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
