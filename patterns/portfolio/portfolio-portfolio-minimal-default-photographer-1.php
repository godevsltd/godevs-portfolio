<?php
/**
 * Title: Portfolio — Minimal List (Photographer)
 * Slug: godevs-portfolio/portfolio-portfolio-minimal-default-photographer-1
 * Description: A minimal list portfolio section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, minimal list, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
