<?php
/**
 * Title: Portfolio — Two Column Large (Consultant)
 * Slug: godevs-portfolio/portfolio-portfolio-2col-default-consultant-1
 * Description: A two column large portfolio section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, two column large, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
