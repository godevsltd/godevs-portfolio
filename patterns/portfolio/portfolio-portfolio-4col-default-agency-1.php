<?php
/**
 * Title: Portfolio — Four Column Grid (Agency)
 * Slug: godevs-portfolio/portfolio-portfolio-4col-default-agency-1
 * Description: A four column grid portfolio section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, four column grid, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
