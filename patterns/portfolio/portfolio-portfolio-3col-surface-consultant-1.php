<?php
/**
 * Title: Portfolio — Three Column Grid (Consultant)
 * Slug: godevs-portfolio/portfolio-portfolio-3col-surface-consultant-1
 * Description: A three column grid portfolio section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, three column grid, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
