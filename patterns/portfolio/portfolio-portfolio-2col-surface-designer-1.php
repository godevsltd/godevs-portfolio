<?php
/**
 * Title: Portfolio — Two Column Large (Designer)
 * Slug: godevs-portfolio/portfolio-portfolio-2col-surface-designer-1
 * Description: A two column large portfolio section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, two column large, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
