<?php
/**
 * Title: Portfolio — Minimal List (Architect)
 * Slug: godevs-portfolio/portfolio-portfolio-minimal-default-architect-1
 * Description: A minimal list portfolio section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, minimal list, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
