<?php
/**
 * Title: Portfolio — Four Column Grid (Architect)
 * Slug: godevs-portfolio/portfolio-portfolio-4col-default-architect-1
 * Description: A four column grid portfolio section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, four column grid, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
