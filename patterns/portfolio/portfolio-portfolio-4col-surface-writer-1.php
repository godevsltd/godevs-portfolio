<?php
/**
 * Title: Portfolio — Four Column Grid (Writer)
 * Slug: godevs-portfolio/portfolio-portfolio-4col-surface-writer-1
 * Description: A four column grid portfolio section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, four column grid, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
