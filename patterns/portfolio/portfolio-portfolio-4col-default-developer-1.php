<?php
/**
 * Title: Portfolio — Four Column Grid (Developer)
 * Slug: godevs-portfolio/portfolio-portfolio-4col-default-developer-1
 * Description: A four column grid portfolio section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, four column grid, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
