<?php
/**
 * Title: Portfolio — Three Column Grid (Architect)
 * Slug: godevs-portfolio/portfolio-portfolio-3col-surface-architect-1
 * Description: A three column grid portfolio section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, three column grid, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
