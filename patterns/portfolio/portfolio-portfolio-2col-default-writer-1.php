<?php
/**
 * Title: Portfolio — Two Column Large (Writer)
 * Slug: godevs-portfolio/portfolio-portfolio-2col-default-writer-1
 * Description: A two column large portfolio section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, two column large, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
