<?php
/**
 * Title: Portfolio — Three Column Grid (Writer)
 * Slug: godevs-portfolio/portfolio-portfolio-3col-default-writer-1
 * Description: A three column grid portfolio section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, three column grid, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
