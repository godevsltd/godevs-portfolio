<?php
/**
 * Title: Portfolio — Four Column Grid (Photographer)
 * Slug: godevs-portfolio/portfolio-portfolio-4col-default-photographer-1
 * Description: A four column grid portfolio section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, four column grid, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
