<?php
/**
 * Title: Portfolio — Two Column Large (Freelancer)
 * Slug: godevs-portfolio/portfolio-portfolio-2col-surface-freelancer-1
 * Description: A two column large portfolio section with freelancer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, two column large, freelancer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
