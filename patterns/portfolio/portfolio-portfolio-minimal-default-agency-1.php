<?php
/**
 * Title: Portfolio — Minimal List (Agency)
 * Slug: godevs-portfolio/portfolio-portfolio-minimal-default-agency-1
 * Description: A minimal list portfolio section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, minimal list, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
