<?php
/**
 * Title: Portfolio — Minimal List (Designer)
 * Slug: godevs-portfolio/portfolio-portfolio-minimal-surface-designer-1
 * Description: A minimal list portfolio section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, minimal list, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
