<?php
/**
 * Title: Portfolio — Four Column Grid (Designer)
 * Slug: godevs-portfolio/portfolio-portfolio-4col-default-designer-1
 * Description: A four column grid portfolio section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, four column grid, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
