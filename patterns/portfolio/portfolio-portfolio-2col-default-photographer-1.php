<?php
/**
 * Title: Portfolio — Two Column Large (Photographer)
 * Slug: godevs-portfolio/portfolio-portfolio-2col-default-photographer-1
 * Description: A two column large portfolio section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, two column large, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
