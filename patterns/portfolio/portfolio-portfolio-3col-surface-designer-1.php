<?php
/**
 * Title: Portfolio — Three Column Grid (Designer)
 * Slug: godevs-portfolio/portfolio-portfolio-3col-surface-designer-1
 * Description: A three column grid portfolio section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, three column grid, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
