<?php
/**
 * Title: Portfolio — Minimal List (Writer)
 * Slug: godevs-portfolio/portfolio-portfolio-minimal-default-writer-1
 * Description: A minimal list portfolio section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, minimal list, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
