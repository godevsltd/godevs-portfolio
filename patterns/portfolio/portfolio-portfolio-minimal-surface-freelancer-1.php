<?php
/**
 * Title: Portfolio — Minimal List (Freelancer)
 * Slug: godevs-portfolio/portfolio-portfolio-minimal-surface-freelancer-1
 * Description: A minimal list portfolio section with freelancer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, minimal list, freelancer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
