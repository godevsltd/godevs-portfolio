<?php
/**
 * Title: Portfolio — Two Column Large (Agency)
 * Slug: godevs-portfolio/portfolio-portfolio-2col-default-agency-1
 * Description: A two column large portfolio section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, two column large, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
