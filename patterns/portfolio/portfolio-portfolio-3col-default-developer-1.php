<?php
/**
 * Title: Portfolio — Three Column Grid (Developer)
 * Slug: godevs-portfolio/portfolio-portfolio-3col-default-developer-1
 * Description: A three column grid portfolio section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, three column grid, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
