<?php
/**
 * Title: Portfolio — Minimal List (Consultant)
 * Slug: godevs-portfolio/portfolio-portfolio-minimal-surface-consultant-1
 * Description: A minimal list portfolio section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-portfolio
 * Keywords: portfolio, minimal list, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
