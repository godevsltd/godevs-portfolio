<?php
/**
 * Title: Demo — Interior (Work)
 * Slug: godevs-portfolio/demo-interior-work
 * Description: Work page for the Interior demo. 3-column portfolio grid with selected projects. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, interior, work, portfolio, grid, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
