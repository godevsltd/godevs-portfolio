<?php
/**
 * Title: Demo — Journalist (About)
 * Slug: godevs-portfolio/demo-journalist-about
 * Description: About page for the Journalist demo. Bio intro, practice areas, and a closing CTA. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, journalist, about, bio, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Journalist, a journalist portfolio.</p>
<!-- /wp:paragraph -->
