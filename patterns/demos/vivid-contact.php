<?php
/**
 * Title: Demo — Vivid (Contact)
 * Slug: godevs-portfolio/demo-vivid-contact
 * Description: Contact page for the Vivid demo. Split form + info layout with optional FAQ. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, vivid, contact, form, email, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@vivid.studio">hello@vivid.studio</a></p>
<!-- /wp:paragraph -->
