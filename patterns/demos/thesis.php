<?php
/**
 * Title: Demo — Thesis (Research Portfolio)
 * Slug: godevs-portfolio/demo-thesis
 * Description: Research portfolio. Editorial typography hero, blog then about, typography CTA. Recommended style variation: Editorial.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, education,, research, portfolio
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-thesis godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-demo-thesis alignfull">
