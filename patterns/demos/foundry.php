...
<section class="wp-block-group alignfull">
        ...
        <div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--90);padding-bottom:var(--wp--preset--spacing--90)">
                ...
                <h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2.75rem, 8vw, 6rem);line-height:1;letter-spacing:-0.025em;font-style:italic;font-weight:500">Foundry — selected work.</h1>
                <!-- /wp:heading -->
