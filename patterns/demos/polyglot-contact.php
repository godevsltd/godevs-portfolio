<?php
/**
 * Title: Demo — Polyglot (Contact)
 * Slug: godevs-portfolio/demo-polyglot-contact
 * Description: Contact page for the Polyglot demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, polyglot, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@polyglot.studio">hello@polyglot.studio</a></p>
<!-- /wp:paragraph -->
