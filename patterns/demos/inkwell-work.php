<?php
/**
 * Title: Demo — Inkwell (Work)
 * Slug: godevs-portfolio/demo-inkwell-work
 * Description: Work page for the Inkwell demo. 2-column portfolio grid with selected projects. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, inkwell, work, portfolio, grid, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
