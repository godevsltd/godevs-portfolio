 ...
 * Description: Services page for the Meridian demo. Three service cards with engagement models. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, meridian, services, consulting
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2rem, 5vw, 3.5rem);line-height:1.1;letter-spacing:-0.025em;font-weight:600">How I help.</h1>
<!-- /wp:heading -->
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|medium);max-width:520px">Three areas of consulting, each scoped in writing with clear deliverables and timelines.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</section>
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|small);margin-top:var(--wp--preset--spacing--20)"><strong>Timeline:</strong> 2-4 weeks<br><strong>Deliverables:</strong> Strategy doc, positioning, roadmap</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"spacing":{"margin":{"top":"var:preset|spacing|20"}},"color":{"text":"var:preset|color|muted"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|small);margin-top:var(--wp--preset--spacing--20)"><strong>Timeline:</strong> 4-6 weeks<br><strong>Deliverables:</strong> Audit, process maps, SOPs</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"spacing":{"margin":{"top":"var:preset|spacing|20"}},"color":{"text":"var:preset|color|muted"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|small);margin-top:var(--wp--preset--spacing--20)"><strong>Timeline:</strong> 2-3 weeks<br><strong>Deliverables:</strong> Audit report, action plan</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
