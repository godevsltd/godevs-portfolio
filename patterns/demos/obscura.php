<?php
/**
 * Title: Demo — Obscura (Studio)
 * Slug: godevs-portfolio/demo-obscura
 * Description: Creative studio portfolio. Dark image-led hero, asymmetric portfolio, full-width dark CTA. Recommended style variation: Dark.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, creative,, studio
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-obscura godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-demo-obscura alignfull">
