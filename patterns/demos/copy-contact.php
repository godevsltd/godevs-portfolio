<?php
/**
 * Title: Demo — Copy (Contact)
 * Slug: godevs-portfolio/demo-copy-contact
 * Description: Contact page for the Copy demo. Split form + info layout with optional FAQ. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, copy, contact, form, email, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@copy.studio">hello@copy.studio</a></p>
<!-- /wp:paragraph -->
