<?php
/**
 * Title: Demo — Freelance (Work)
 * Slug: godevs-portfolio/demo-freelance-work
 * Description: Work page for the Freelance demo. 2-column portfolio grid with selected projects. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, freelance, work, portfolio, grid, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
