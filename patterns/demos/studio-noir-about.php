<?php
/**
 * Title: Demo — Studio Noir (About)
 * Slug: godevs-portfolio/demo-studio-noir-about
 * Description: About page for the Studio Noir demo. Bio intro, practice areas, and a closing CTA. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, studio-noir, about, bio, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Studio Noir is a design practice focused on identity, editorial, and product work.</p>
<!-- /wp:paragraph -->
