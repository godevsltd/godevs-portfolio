<?php
/**
 * Title: Demo — Copy (Work)
 * Slug: godevs-portfolio/demo-copy-work
 * Description: Work page for the Copy demo. 2-column portfolio grid with selected projects. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, copy, work, portfolio, grid, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
