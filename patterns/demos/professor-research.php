<?php
/**
 * Title: Demo — Professor (Research)
 * Slug: godevs-portfolio/demo-professor-research
 * Description: Research page for the Professor demo. Focus areas and publications framed as a stats/experience composition. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, professor, research, publications, focus areas, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p class="is-style-eyebrow">Research</p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size--xx-large);letter-spacing:-0.02em;font-weight:600">Focus areas & publications.</h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|medium"},"layout":{"selfStretch":"fit","flexSize":"560px"}}} -->
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">A working list of research threads and publications — kept current, archived honestly.</p>
<!-- /wp:paragraph -->
...
<!-- wp:button -->
<div class="wp-block-button"><a href="#publications" class="wp-block-button__link wp-element-button">Read the publications</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
