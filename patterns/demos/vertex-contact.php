<?php
/**
 * Title: Demo — Vertex (Contact)
 * Slug: godevs-portfolio/demo-vertex-contact
 * Description: Contact page for the Vertex demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, vertex, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@vertex.studio">hello@vertex.studio</a></p>
<!-- /wp:paragraph -->
