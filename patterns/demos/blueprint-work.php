<?php
/**
 * Title: Demo — Blueprint (Work)
 * Slug: godevs-portfolio/demo-blueprint-work
 * Description: Work page for the Blueprint demo. 2-column portfolio grid with selected projects. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, blueprint, work, portfolio, grid, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
