<?php
/**
 * Title: Demo — Modern Freelance (Contact)
 * Slug: godevs-portfolio/demo-modern-freelance-contact
 * Description: Contact page for the Modern Freelance demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, modern-freelance, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@modern-freelance.studio">hello@modern-freelance.studio</a></p>
<!-- /wp:paragraph -->
