<?php
/**
 * Title: Demo — Frame (Work)
 * Slug: godevs-portfolio/demo-frame-work
 * Description: Work page for the Frame demo. 4-column portfolio grid with selected projects. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, frame, work, portfolio, grid, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
