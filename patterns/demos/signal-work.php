<?php
/**
 * Title: Demo — Signal (Work)
 * Slug: godevs-portfolio/demo-signal-work
 * Description: Work page for the Signal demo. 2-column portfolio grid with selected projects. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, signal, work, portfolio, grid, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
