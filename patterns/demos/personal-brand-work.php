<?php
/**
 * Title: Demo — Personal Brand (Work)
 * Slug: godevs-portfolio/demo-personal-brand-work
 * Description: Work page for the Personal Brand demo. 2-column portfolio grid with selected projects. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, personal-brand, work, portfolio, grid, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
