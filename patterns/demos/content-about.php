<?php
/**
 * Title: Demo — Content (About)
 * Slug: godevs-portfolio/demo-content-about
 * Description: About page for the Content demo. Bio intro, practice areas, and a closing CTA. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, content, about, bio, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Content is a creative practice documenting and designing for considered living.</p>
<!-- /wp:paragraph -->
