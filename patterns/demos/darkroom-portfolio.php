<?php
/**
 * Title: Demo — Darkroom (Work)
 * Slug: godevs-portfolio/demo-darkroom-work
 * Description: Work page for the Darkroom demo. 2-column portfolio grid with selected projects. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, darkroom, work, portfolio, grid, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
