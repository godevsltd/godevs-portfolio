<?php
/**
 * Title: Demo — Searchlight (Contact)
 * Slug: godevs-portfolio/demo-searchlight-contact
 * Description: Contact page for the Searchlight demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, searchlight, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@searchlight.studio">hello@searchlight.studio</a></p>
<!-- /wp:paragraph -->
