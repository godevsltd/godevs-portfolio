<?php
/**
 * Title: Demo — Draft (Work)
 * Slug: godevs-portfolio/demo-draft-work
 * Description: Work page for the Draft demo. 2-column portfolio grid with selected projects. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, draft, work, portfolio, grid, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
