<?php
/**
 * Title: Demo — Studio Craft (Contact)
 * Slug: godevs-portfolio/demo-studio-craft-contact
 * Description: Contact page for the Studio Craft demo. Split form + info layout with optional FAQ. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, studio-craft, contact, form, email, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@studio-craft.studio">hello@studio-craft.studio</a></p>
<!-- /wp:paragraph -->
