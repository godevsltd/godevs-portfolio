<?php
/**
 * Title: Demo — Research (Teaching)
 * Slug: godevs-portfolio/demo-research-teaching
 * Description: Teaching page for the Research demo. Courses and programs framed as a services-style composition. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, research, teaching, courses, programs, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
