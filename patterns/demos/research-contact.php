<?php
/**
 * Title: Demo — Research (Contact)
 * Slug: godevs-portfolio/demo-research-contact
 * Description: Contact page for the Research demo. Split form + info layout with optional FAQ. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, research, contact, form, email, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@research.studio">hello@research.studio</a></p>
<!-- /wp:paragraph -->
