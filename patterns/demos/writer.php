<?php
/**
 * Title: Demo — Writer (Writer)
 * Slug: godevs-portfolio/demo-writer
 * Description: Writer portfolio. Minimal display hero, blog then about, minimal CTA. Reading-first. Recommended style variation: Minimal.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, personal,, writer
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-writer godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-demo-writer alignfull">
...
<p class="is-style-eyebrow has-text-align-center">Personal / Writer</p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading has-text-align-center" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2rem, 5vw, 4rem);line-height:1.05;letter-spacing:-0.025em;font-weight:600">Writer</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"var:preset|font-size|medium"},"layout":{"selfStretch":"fit","flexSize":"480px"}}} -->
<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--medium);max-width:480px">Writer portfolio. Minimal display hero, blog then about, minimal CTA. Reading-first.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</section>
