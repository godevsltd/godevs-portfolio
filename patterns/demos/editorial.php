<?php
/**
 * Title: Demo — Editorial (Editorial)
 * Slug: godevs-portfolio/demo-editorial
 * Description: Editorial portfolio. Editorial typography hero, blog then testimonials, typography CTA. Recommended style variation: Editorial.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, lifestyle,, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-editorial godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-demo-editorial alignfull">
...
<p class="is-style-eyebrow has-text-color" style="color:var(--wp--preset--color--muted)">Lifestyle / Editorial</p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2rem, 5vw, 4rem);line-height:1.1;letter-spacing:-0.02em;font-weight:600">Editorial.</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|medium"},"layout":{"selfStretch":"fit","flexSize":"520px"}}} -->
<p style="font-size:var(--wp--preset--font-size--medium);max-width:520px">Editorial portfolio. Editorial typography hero, blog then testimonials, typography CTA.</p>
<!-- /wp:paragraph -->
<!-- wp:buttons -->
