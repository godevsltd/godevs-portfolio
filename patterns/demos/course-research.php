<?php
/**
 * Title: Demo — Course (Research)
 * Slug: godevs-portfolio/demo-course-research
 * Description: Research page for the Course demo. Focus areas and publications framed as a stats/experience composition. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, course, research, publications, focus areas, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
