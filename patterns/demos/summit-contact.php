<?php
/**
 * Title: Demo — Summit (Contact)
 * Slug: godevs-portfolio/demo-summit-contact
 * Description: Contact page for the Summit demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, summit, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@summit.studio">hello@summit.studio</a></p>
<!-- /wp:paragraph -->
