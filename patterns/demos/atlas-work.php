<?php
/**
 * Title: Demo — Atlas (Work)
 * Slug: godevs-portfolio/demo-atlas-work
 * Description: Work page for the Atlas demo. 2-column portfolio grid with selected projects. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, atlas, work, portfolio, grid, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
