<?php
/**
 * Title: Demo — Stack (Contact)
 * Slug: godevs-portfolio/demo-stack-contact
 * Description: Contact page for the Stack demo. Split form + info layout with optional FAQ. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, stack, contact, form, email, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@stack.studio">hello@stack.studio</a></p>
<!-- /wp:paragraph -->
