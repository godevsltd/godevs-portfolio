<?php
/**
 * Title: Demo — Compass (Contact)
 * Slug: godevs-portfolio/demo-compass-contact
 * Description: Contact page for the Compass demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, compass, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@compass.studio">hello@compass.studio</a></p>
<!-- /wp:paragraph -->
