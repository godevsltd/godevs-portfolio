<?php
/**
 * Title: Demo — Personal Brand (About)
 * Slug: godevs-portfolio/demo-personal-brand-about
 * Description: About page for the Personal Brand demo. Bio intro, practice areas, and a closing CTA. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, personal-brand, about, bio, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Personal Brand, a personal brand site (alternate).</p>
<!-- /wp:paragraph -->
