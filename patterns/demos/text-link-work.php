<?php
/**
 * Title: Demo — Text Link (Work)
 * Slug: godevs-portfolio/demo-text-link-work
 * Description: Work page for the Text Link demo. 2-column portfolio grid with selected projects. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, text-link, work, portfolio, grid, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
