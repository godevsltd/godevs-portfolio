<?php
/**
 * Title: Demo — Teacher (Contact)
 * Slug: godevs-portfolio/demo-teacher-contact
 * Description: Contact page for the Teacher demo. Split form + info layout with optional FAQ. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, teacher, contact, form, email, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@teacher.studio">hello@teacher.studio</a></p>
<!-- /wp:paragraph -->
