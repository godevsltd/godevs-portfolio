<?php
/**
 * Title: Demo — Wander (Contact)
 * Slug: godevs-portfolio/demo-wander-contact
 * Description: Contact page for the Wander demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, wander, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@wander.studio">hello@wander.studio</a></p>
<!-- /wp:paragraph -->
