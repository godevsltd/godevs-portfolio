<?php
/**
 * Title: Demo — Codecraft (Contact)
 * Slug: godevs-portfolio/demo-codecraft-contact
 * Description: Contact page for the Codecraft demo. Split form + info layout with optional FAQ. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, codecraft, contact, form, email, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@codecraft.studio">hello@codecraft.studio</a></p>
<!-- /wp:paragraph -->
