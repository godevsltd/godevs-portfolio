<?php
/**
 * Title: Demo — Founder (Contact)
 * Slug: godevs-portfolio/demo-founder-contact
 * Description: Contact page for the Founder demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, founder, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@founder.studio">hello@founder.studio</a></p>
<!-- /wp:paragraph -->
