<?php
/**
 * Title: Demo — Verdure (Work)
 * Slug: godevs-portfolio/demo-verdure-work
 * Description: Work page for the Verdure demo. 2-column portfolio grid with selected projects. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, verdure, work, portfolio, grid, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
