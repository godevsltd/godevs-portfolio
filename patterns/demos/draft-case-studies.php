<?php
/**
 * Title: Demo — Draft (Case Studies)
 * Slug: godevs-portfolio/demo-draft-case-studies
 * Description: Case studies page for the Draft demo. Three case-study preview cards with result metrics. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, draft, case studies, results, metrics, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
