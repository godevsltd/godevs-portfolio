<?php
/**
 * Title: Demo — Professor (Contact)
 * Slug: godevs-portfolio/demo-professor-contact
 * Description: Contact page for the Professor demo. Split form + info layout with optional FAQ. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, professor, contact, form, email, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@professor.studio">hello@professor.studio</a></p>
<!-- /wp:paragraph -->
