<?php
/**
 * Title: Demo — Lifestyle (Contact)
 * Slug: godevs-portfolio/demo-lifestyle-contact
 * Description: Contact page for the Lifestyle demo. Split form + info layout with optional FAQ. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, lifestyle, contact, form, email, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@lifestyle.studio">hello@lifestyle.studio</a></p>
<!-- /wp:paragraph -->
