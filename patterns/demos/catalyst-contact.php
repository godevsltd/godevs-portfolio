<?php
/**
 * Title: Demo — Catalyst (Contact)
 * Slug: godevs-portfolio/demo-catalyst-contact
 * Description: Contact page for the Catalyst demo. Split form + info layout with optional FAQ. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, catalyst, contact, form, email, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@catalyst.studio">hello@catalyst.studio</a></p>
<!-- /wp:paragraph -->
