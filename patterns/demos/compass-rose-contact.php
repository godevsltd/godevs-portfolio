<?php
/**
 * Title: Demo — Compass Rose (Contact)
 * Slug: godevs-portfolio/demo-compass-rose-contact
 * Description: Contact page for the Compass Rose demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, compass-rose, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@compass-rose.studio">hello@compass-rose.studio</a></p>
<!-- /wp:paragraph -->
