<?php
/**
 * Title: Demo — Terminal (About)
 * Slug: godevs-portfolio/demo-terminal-about
 * Description: About page for the Terminal demo. Bio intro, practice areas, and a closing CTA. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, terminal, about, bio, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Terminal is an independent practice working at the intersection of design and engineering.</p>
<!-- /wp:paragraph -->
