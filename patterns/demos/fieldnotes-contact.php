<?php
/**
 * Title: Demo — Fieldnotes (Contact)
 * Slug: godevs-portfolio/demo-fieldnotes-contact
 * Description: Contact page for the Fieldnotes demo. Split form + info layout with optional FAQ. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, fieldnotes, contact, form, email, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@fieldnotes.studio">hello@fieldnotes.studio</a></p>
<!-- /wp:paragraph -->
