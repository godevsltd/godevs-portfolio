<?php
/**
 * Title: Demo — Visage (Work)
 * Slug: godevs-portfolio/demo-visage-work
 * Description: Work page for the Visage demo. 2-column portfolio grid with selected projects. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, visage, work, portfolio, grid, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
