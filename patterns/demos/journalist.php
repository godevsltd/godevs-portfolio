<?php
/**
 * Title: Demo — Journalist (Journalist)
 * Slug: godevs-portfolio/demo-journalist
 * Description: Journalist portfolio. Editorial typography hero, blog then about, typography CTA with newsletter footer. Recommended style variation: Editorial.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, specialized,, journalist
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-journalist godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-demo-journalist alignfull">
...
<p class="is-style-eyebrow">Specialized / Journalist</p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2.5rem, 6vw, 5rem);line-height:1.05;letter-spacing:-0.02em;font-weight:600">Journalist</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|medium"},"layout":{"selfStretch":"fit","flexSize":"520px"}}} -->
<p style="font-size:var(--wp--preset--font-size--medium);max-width:520px">Journalist portfolio. Editorial typography hero, blog then about, typography CTA with newsletter footer.</p>
<!-- /wp:paragraph -->
