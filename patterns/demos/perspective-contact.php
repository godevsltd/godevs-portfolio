<?php
/**
 * Title: Demo — Perspective (Contact)
 * Slug: godevs-portfolio/demo-perspective-contact
 * Description: Contact page for the Perspective demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, perspective, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@perspective.studio">hello@perspective.studio</a></p>
<!-- /wp:paragraph -->
