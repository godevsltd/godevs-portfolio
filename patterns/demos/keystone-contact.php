<?php
/**
 * Title: Demo — Keystone (Contact)
 * Slug: godevs-portfolio/demo-keystone-contact
 * Description: Contact page for the Keystone demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, keystone, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@keystone.studio">hello@keystone.studio</a></p>
<!-- /wp:paragraph -->
