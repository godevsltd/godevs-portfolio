 ...
 * Description: About page for the Meridian demo. Bio intro, practice areas, and a closing CTA. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, meridian, about, bio, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Meridian is a consulting practice helping teams make better decisions about their products and processes.</p>
<!-- /wp:paragraph -->
