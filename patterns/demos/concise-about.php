<?php
/**
 * Title: Demo — Concise (About)
 * Slug: godevs-portfolio/demo-concise-about
 * Description: About page for the Concise demo. Bio intro, practice areas, and a closing CTA. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, concise, about, bio, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Concise is a creative practice documenting and designing for considered living.</p>
<!-- /wp:paragraph -->
