<?php
/**
 * Title: Demo — Syntax (Contact)
 * Slug: godevs-portfolio/demo-syntax-contact
 * Description: Contact page for the Syntax demo. Split form + info layout with optional FAQ. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, syntax, contact, form, email, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@syntax.studio">hello@syntax.studio</a></p>
<!-- /wp:paragraph -->
