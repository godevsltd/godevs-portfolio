<?php
/**
 * Title: Demo — Atelier (Contact)
 * Slug: godevs-portfolio/demo-atelier-contact
 * Description: Contact page for the Atelier demo. Split form + info layout with optional FAQ. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, atelier, contact, form, email, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@atelier.studio">hello@atelier.studio</a></p>
<!-- /wp:paragraph -->
