<?php
/**
 * Title: Demo — Searchlight (Work)
 * Slug: godevs-portfolio/demo-searchlight-work
 * Description: Work page for the Searchlight demo. 2-column portfolio grid with selected projects. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, searchlight, work, portfolio, grid, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
