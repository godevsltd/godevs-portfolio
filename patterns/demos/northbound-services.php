 ...
 * Description: Services page for the Northbound demo. Three service cards with process steps. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, northbound, services, agency
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p class="is-style-eyebrow has-text-color" style="color:var(--wp--preset--color--muted)">Services</p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2rem, 5vw, 3.5rem);line-height:1.1;letter-spacing:-0.025em;font-weight:600">What we do.</h1>
<!-- /wp:heading -->
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|medium);max-width:520px">Three areas of practice, often combined into one engagement. Each is scoped in writing with clear deliverables.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</section>
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|small)">Positioning, messaging, audience research. The foundation that makes design decisions easier.</p>
<!-- /wp:paragraph -->
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|small);margin-top:var(--wp--preset--spacing--20)"><strong>Timeline:</strong> 2-4 weeks<br><strong>Deliverables:</strong> Strategy doc, positioning, messaging</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"color":{"text":"var:preset|color|muted"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|small)">Logos, type systems, color palettes, guidelines. The visual language that makes a brand recognizable.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"spacing":{"margin":{"top":"var:preset|spacing|20"}},"color":{"text":"var:preset|color|muted"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|small);margin-top:var(--wp--preset--spacing--20)"><strong>Timeline:</strong> 6-8 weeks<br><strong>Deliverables:</strong> Identity system, guidelines, templates</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"spacing":{"margin":{"top":"var:preset|spacing|20"}},"color":{"text":"var:preset|color|muted"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|small);margin-top:var(--wp--preset--spacing--20)"><strong>Timeline:</strong> 8-12 weeks<br><strong>Deliverables:</strong> Website, components, handoff</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
