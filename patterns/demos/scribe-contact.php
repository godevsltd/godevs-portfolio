<?php
/**
 * Title: Demo — Scribe (Contact)
 * Slug: godevs-portfolio/demo-scribe-contact
 * Description: Contact page for the Scribe demo. Split form + info layout with optional FAQ. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, scribe, contact, form, email, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@scribe.studio">hello@scribe.studio</a></p>
<!-- /wp:paragraph -->
