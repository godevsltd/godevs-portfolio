<?php
/**
 * Title: Demo — Workshop (Work)
 * Slug: godevs-portfolio/demo-workshop-work
 * Description: Work page for the Workshop demo. 2-column portfolio grid with selected projects. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, workshop, work, portfolio, grid, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
