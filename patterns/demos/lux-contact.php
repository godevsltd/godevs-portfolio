<?php
/**
 * Title: Demo — Lux (Contact)
 * Slug: godevs-portfolio/demo-lux-contact
 * Description: Contact page for the Lux demo. Split form + info layout with optional FAQ. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, lux, contact, form, email, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@lux.studio">hello@lux.studio</a></p>
<!-- /wp:paragraph -->
