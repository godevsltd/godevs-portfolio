<?php
/**
 * Title: Demo — Palette (Case Studies)
 * Slug: godevs-portfolio/demo-palette-case-studies
 * Description: Case studies page for the Palette demo. Three case-study preview cards with result metrics. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, palette, case studies, results, metrics, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
