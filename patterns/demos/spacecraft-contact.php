<?php
/**
 * Title: Demo — Spacecraft (Contact)
 * Slug: godevs-portfolio/demo-spacecraft-contact
 * Description: Contact page for the Spacecraft demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, spacecraft, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@spacecraft.studio">hello@spacecraft.studio</a></p>
<!-- /wp:paragraph -->
