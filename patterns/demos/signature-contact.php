 ...
 * Description: Contact page for the Signature demo. Split form + info layout with optional FAQ. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, signature, contact, form, email, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
