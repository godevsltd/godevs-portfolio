 ...
 * Description: Contact page for the Signature demo. Split info + form. Uses the Elegant style variation.
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--serif);font-size:clamp(2rem, 5vw, 3.5rem);line-height:1.1;letter-spacing:-0.025em;font-weight:400;font-style:italic">Let's talk.</h1>
<!-- /wp:heading -->
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|medium);max-width:520px">I work with 6 clients per year. Tell me about yourself and I'll tell you if we're a fit.</p>
<!-- /wp:paragraph -->
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@signature.studio">hello@signature.studio</a></p>
<!-- /wp:paragraph -->
...
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|medium"}}} -->
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="#">Instagram</a> · <a href="#">LinkedIn</a> · <a href="#">Twitter</a></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"60%"} -->
...
<!-- wp:paragraph {"className":"is-style-eyebrow","style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.12em","fontWeight":"600"},"color":{"text":"var:preset|color|accent"}}} -->
<p class="is-style-eyebrow">Tell me about yourself</p>
<!-- /wp:paragraph -->
...
<p class="has-text-color has-border-color" style="border-color:var(--wp--preset--color--border);border-width:1px;border-radius:6px;color:var(--wp--preset--color--muted);min-height:100px;margin-top:var(--wp--preset--spacing--20);padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)">Who are you? What do you do? What do you want to be known for?</p>
<!-- /wp:paragraph -->
