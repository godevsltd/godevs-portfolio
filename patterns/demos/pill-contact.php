<?php
/**
 * Title: Demo — Pill (Contact)
 * Slug: godevs-portfolio/demo-pill-contact
 * Description: Contact page for the Pill demo. Split form + info layout with optional FAQ. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, pill, contact, form, email, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@pill.studio">hello@pill.studio</a></p>
<!-- /wp:paragraph -->
