<?php
/**
 * Title: Demo — Studio Light (Work)
 * Slug: godevs-portfolio/demo-studio-light-work
 * Description: Work page for the Studio Light demo. 3-column portfolio grid with selected projects. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, studio-light, work, portfolio, grid, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
