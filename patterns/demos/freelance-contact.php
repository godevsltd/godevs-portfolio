<?php
/**
 * Title: Demo — Freelance (Contact)
 * Slug: godevs-portfolio/demo-freelance-contact
 * Description: Contact page for the Freelance demo. Split form + info layout with optional FAQ. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, freelance, contact, form, email, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@freelance.studio">hello@freelance.studio</a></p>
<!-- /wp:paragraph -->
