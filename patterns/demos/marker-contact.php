<?php
/**
 * Title: Demo — Marker (Contact)
 * Slug: godevs-portfolio/demo-marker-contact
 * Description: Contact page for the Marker demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, marker, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@marker.studio">hello@marker.studio</a></p>
<!-- /wp:paragraph -->
