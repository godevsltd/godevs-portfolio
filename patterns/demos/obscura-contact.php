<?php
/**
 * Title: Demo — Obscura (Contact)
 * Slug: godevs-portfolio/demo-obscura-contact
 * Description: Contact page for the Obscura demo. Split form + info layout with optional FAQ. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, obscura, contact, form, email, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@obscura.studio">hello@obscura.studio</a></p>
<!-- /wp:paragraph -->
