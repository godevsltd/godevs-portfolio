<?php
/**
 * Title: Demo — Vantage (About)
 * Slug: godevs-portfolio/demo-vantage-about
 * Description: About page for the Vantage demo. Bio intro, practice areas, and a closing CTA. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, vantage, about, bio, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Vantage is a consulting practice helping teams make better decisions about their products and processes.</p>
<!-- /wp:paragraph -->
