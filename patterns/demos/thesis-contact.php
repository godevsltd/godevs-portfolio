<?php
/**
 * Title: Demo — Thesis (Contact)
 * Slug: godevs-portfolio/demo-thesis-contact
 * Description: Contact page for the Thesis demo. Split form + info layout with optional FAQ. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, thesis, contact, form, email, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@thesis.studio">hello@thesis.studio</a></p>
<!-- /wp:paragraph -->
