<?php
/**
 * Title: Demo — Lux (About)
 * Slug: godevs-portfolio/demo-lux-about
 * Description: About page for the Lux demo. Bio intro, practice areas, and a closing CTA. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, lux, about, bio, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Lux is a creative practice documenting and designing for considered living.</p>
<!-- /wp:paragraph -->
