<?php
/**
 * Title: Demo — Freelance (About)
 * Slug: godevs-portfolio/demo-freelance-about
 * Description: About page for the Freelance demo. Bio intro, practice areas, and a closing CTA. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, freelance, about, bio, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Freelance, a freelancer portfolio.</p>
<!-- /wp:paragraph -->
