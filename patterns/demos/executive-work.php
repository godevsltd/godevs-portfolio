<?php
/**
 * Title: Demo — Executive (Work)
 * Slug: godevs-portfolio/demo-executive-work
 * Description: Work page for the Executive demo. 2-column portfolio grid with selected projects. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, executive, work, portfolio, grid, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
