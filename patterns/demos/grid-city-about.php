<?php
/**
 * Title: Demo — Grid City (About)
 * Slug: godevs-portfolio/demo-grid-city-about
 * Description: About page for the Grid City demo. Bio intro, practice areas, and a closing CTA. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, grid-city, about, bio, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Grid City is an architecture and design practice focused on considered, context-aware work.</p>
<!-- /wp:paragraph -->
