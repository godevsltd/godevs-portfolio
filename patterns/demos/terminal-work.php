<?php
/**
 * Title: Demo — Terminal (Work)
 * Slug: godevs-portfolio/demo-terminal-work
 * Description: Work page for the Terminal demo. 2-column portfolio grid with selected projects. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, terminal, work, portfolio, grid, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
