<?php
/**
 * Title: Demo — Independent (Contact)
 * Slug: godevs-portfolio/demo-independent-contact
 * Description: Contact page for the Independent demo. Split form + info layout with optional FAQ. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, independent, contact, form, email, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@independent.studio">hello@independent.studio</a></p>
<!-- /wp:paragraph -->
