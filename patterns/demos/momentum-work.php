<?php
/**
 * Title: Demo — Momentum (Work)
 * Slug: godevs-portfolio/demo-momentum-work
 * Description: Work page for the Momentum demo. 2-column portfolio grid with selected projects. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, momentum, work, portfolio, grid, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
