<?php
/**
 * Title: Demo — Founder (Work)
 * Slug: godevs-portfolio/demo-founder-work
 * Description: Work page for the Founder demo. 2-column portfolio grid with selected projects. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, founder, work, portfolio, grid, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
