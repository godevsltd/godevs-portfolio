<?php
/**
 * Title: Demo — Gridline (Contact)
 * Slug: godevs-portfolio/demo-gridline-contact
 * Description: Contact page for the Gridline demo. Split form + info layout with optional FAQ. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, gridline, contact, form, email, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@gridline.studio">hello@gridline.studio</a></p>
<!-- /wp:paragraph -->
