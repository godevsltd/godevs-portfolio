<?php
/**
 * Title: Demo — Form (Work)
 * Slug: godevs-portfolio/demo-form-work
 * Description: Work page for the Form demo. 4-column portfolio grid with selected projects. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, form, work, portfolio, grid, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
