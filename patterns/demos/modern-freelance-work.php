<?php
/**
 * Title: Demo — Modern Freelance (Work)
 * Slug: godevs-portfolio/demo-modern-freelance-work
 * Description: Work page for the Modern Freelance demo. 2-column portfolio grid with selected projects. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, modern-freelance, work, portfolio, grid, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
