<?php
/**
 * Title: Demo — Text Link (About)
 * Slug: godevs-portfolio/demo-text-link-about
 * Description: About page for the Text Link demo. Bio intro, practice areas, and a closing CTA. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, text-link, about, bio, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Text Link, a personal portfolio with text-link cta header.</p>
<!-- /wp:paragraph -->
