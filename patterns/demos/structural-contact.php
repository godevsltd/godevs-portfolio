<?php
/**
 * Title: Demo — Structural (Contact)
 * Slug: godevs-portfolio/demo-structural-contact
 * Description: Contact page for the Structural demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, structural, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@structural.studio">hello@structural.studio</a></p>
<!-- /wp:paragraph -->
