<?php
/**
 * Title: Demo — Blueprint Studio (Contact)
 * Slug: godevs-portfolio/demo-blueprint-studio-contact
 * Description: Contact page for the Blueprint Studio demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, blueprint-studio, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@blueprint-studio.studio">hello@blueprint-studio.studio</a></p>
<!-- /wp:paragraph -->
