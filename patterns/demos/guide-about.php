<?php
/**
 * Title: Demo — Guide (About)
 * Slug: godevs-portfolio/demo-guide-about
 * Description: About page for the Guide demo. Bio intro, practice areas, and a closing CTA. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, guide, about, bio, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Guide is an academic practice spanning research, teaching, and writing.</p>
<!-- /wp:paragraph -->
