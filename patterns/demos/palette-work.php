<?php
/**
 * Title: Demo — Palette (Work)
 * Slug: godevs-portfolio/demo-palette-work
 * Description: Work page for the Palette demo. 2-column portfolio grid with selected projects. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, palette, work, portfolio, grid, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
