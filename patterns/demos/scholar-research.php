 ...
 * Description: Research page for the Scholar demo. Focus areas and publications framed as a stats/experience composition. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, scholar, research, publications, focus areas, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
