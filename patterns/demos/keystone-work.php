<?php
/**
 * Title: Demo — Keystone (Work)
 * Slug: godevs-portfolio/demo-keystone-work
 * Description: Work page for the Keystone demo. 3-column portfolio grid with selected projects. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, keystone, work, portfolio, grid, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
