<?php
/**
 * Title: Demo — Magazine (Work)
 * Slug: godevs-portfolio/demo-magazine-work
 * Description: Work page for the Magazine demo. 2-column portfolio grid with selected projects. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, magazine, work, portfolio, grid, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
