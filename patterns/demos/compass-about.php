<?php
/**
 * Title: Demo — Compass (About)
 * Slug: godevs-portfolio/demo-compass-about
 * Description: About page for the Compass demo. Bio intro, practice areas, and a closing CTA. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, compass, about, bio, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Compass is a photography practice working across editorial, product, and portrait commissions.</p>
<!-- /wp:paragraph -->
