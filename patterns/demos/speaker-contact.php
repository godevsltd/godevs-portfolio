<?php
/**
 * Title: Demo — Speaker (Contact)
 * Slug: godevs-portfolio/demo-speaker-contact
 * Description: Contact page for the Speaker demo. Split form + info layout with optional FAQ. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, speaker, contact, form, email, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@speaker.studio">hello@speaker.studio</a></p>
<!-- /wp:paragraph -->
