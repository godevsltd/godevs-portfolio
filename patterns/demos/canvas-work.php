 ...
 * Description: Work page for the Canvas demo. 3-column portfolio grid with selected projects. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, canvas, work, portfolio, grid, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
