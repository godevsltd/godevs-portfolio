<?php
/**
 * Title: Demo — Academia (Portfolio)
 * Slug: godevs-portfolio/demo-academia
 * Description: Academic portfolio. Minimal hero, résumé-style experience, minimal CTA. Restrained. Recommended style variation: Minimal.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, education,, portfolio
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-academia godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-demo-academia alignfull">
...
<p class="is-style-eyebrow">Education / Portfolio</p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2.5rem, 6vw, 5rem);line-height:1.05;letter-spacing:-0.02em;font-weight:600">Academia</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|medium"},"layout":{"selfStretch":"fit","flexSize":"520px"}}} -->
<p style="font-size:var(--wp--preset--font-size--medium);max-width:520px">Academic portfolio. Minimal hero, résumé-style experience, minimal CTA. Restrained.</p>
<!-- /wp:paragraph -->
