<?php
/**
 * Title: Demo — Scribe (Author)
 * Slug: godevs-portfolio/demo-scribe
 * Description: Author site. Editorial typography hero, blog then testimonials, typography CTA with newsletter footer. Recommended style variation: Editorial.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, personal,, author
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-scribe godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-demo-scribe alignfull">
...
<p class="is-style-eyebrow">Personal / Author</p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--serif);font-size:clamp(2.5rem, 6vw, 5rem);line-height:1.1;letter-spacing:-0.02em;font-weight:400;font-style:italic">Scribe</h1>
<!-- /wp:heading -->
...
<p style="font-family:var(--wp--preset--font-family--serif);font-size:var(--wp--preset--font-size--large);line-height:1.5;max-width:520px">Author site. Editorial typography hero, blog then testimonials, typography CTA with newsletter footer.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</section>
