<?php
/**
 * Title: Demo — Guide (Teaching)
 * Slug: godevs-portfolio/demo-guide-teaching
 * Description: Teaching page for the Guide demo. Courses and programs framed as a services-style composition. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, guide, teaching, courses, programs, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
