<?php
/**
 * Title: Demo — Stack (About)
 * Slug: godevs-portfolio/demo-stack-about
 * Description: About page for the Stack demo. Bio intro, practice areas, and a closing CTA. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, stack, about, bio, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Stack, a stacked personal portfolio.</p>
<!-- /wp:paragraph -->
