<?php
/**
 * Title: Demo — Compass (Work)
 * Slug: godevs-portfolio/demo-compass-work
 * Description: Work page for the Compass demo. 4-column portfolio grid with selected projects. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, compass, work, portfolio, grid, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<div class="wp-block-column" style="flex-basis:25%">
<!-- wp:image {"aspectRatio":"4/3","scale":"cover","style":{"border":{"radius":"8px"}}} -->
<figure class="wp-block-image has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/placeholder-portrait.jpg' ); ?>" alt="Project: Workshop — Editorial" style="aspect-ratio:4/3;object-fit:cover;border-radius:8px"/></figure>
<!-- /wp:image -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"color":{"text":"var:preset|color|muted"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small)">2024 · Identity</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":4,"style":{"typography":{"letterSpacing":"-0.01em"}}} -->
<h4 class="wp-block-heading" style="letter-spacing:-0.01em">Workshop — Editorial</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:column -->
<!-- wp:column -->
<div class="wp-block-column" style="flex-basis:25%">
<!-- wp:image {"aspectRatio":"4/3","scale":"cover","style":{"border":{"radius":"8px"}}} -->
<figure class="wp-block-image has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/placeholder-portrait.jpg' ); ?>" alt="Project: Meridian — Brand System" style="aspect-ratio:4/3;object-fit:cover;border-radius:8px"/></figure>
<!-- /wp:image -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"color":{"text":"var:preset|color|muted"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small)">2024 · Editorial</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":4,"style":{"typography":{"letterSpacing":"-0.01em"}}} -->
<h4 class="wp-block-heading" style="letter-spacing:-0.01em">Meridian — Brand System</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:column -->
</div>
