<?php
/**
 * Title: Demo — Academia (About)
 * Slug: godevs-portfolio/demo-academia-about
 * Description: About page for the Academia demo. Bio intro, practice areas, and a closing CTA. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, academia, about, bio, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Academia is an academic practice spanning research, teaching, and writing.</p>
<!-- /wp:paragraph -->
