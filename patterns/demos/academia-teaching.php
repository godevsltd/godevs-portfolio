<?php
/**
 * Title: Demo — Academia (Teaching)
 * Slug: godevs-portfolio/demo-academia-teaching
 * Description: Teaching page for the Academia demo. Courses and programs framed as a services-style composition. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, academia, teaching, courses, programs, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
