<?php
/**
 * Title: Demo — Frame Works (Work)
 * Slug: godevs-portfolio/demo-frame-works-work
 * Description: Work page for the Frame Works demo. 2-column portfolio grid with selected projects. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, frame-works, work, portfolio, grid, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
