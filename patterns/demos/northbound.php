...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-northbound","layout":{"type":"default"}} -->
...
<section class="wp-block-group alignfull has-contrast-color has-primary-background-color has-text-color has-background">
        ...
        <div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--90);padding-bottom:var(--wp--preset--spacing--80)">
                ...
                <p class="is-style-eyebrow">Agency / Creative</p>
                <!-- /wp:paragraph -->
                ...
                <h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2.75rem, 8vw, 6rem);line-height:1;letter-spacing:-0.025em;font-weight:700">Northbound — selected work.</h1>
                <!-- /wp:heading -->
