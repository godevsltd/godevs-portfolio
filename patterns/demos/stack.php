<?php
/**
 * Title: Demo — Stack (Stacked)
 * Slug: godevs-portfolio/demo-stack
 * Description: Stacked personal portfolio. Stacked header with large title, résumé-style experience, typography CTA. Recommended style variation: Minimal.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, personal,, stacked
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-stack godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-demo-stack alignfull">
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2.5rem, 6vw, 5rem);line-height:1;letter-spacing:-0.03em;font-weight:600">Stack — selected work.</h1>
<!-- /wp:heading -->
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small)">Personal / Stacked</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</section>
