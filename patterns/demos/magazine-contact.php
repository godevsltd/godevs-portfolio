<?php
/**
 * Title: Demo — Magazine (Contact)
 * Slug: godevs-portfolio/demo-magazine-contact
 * Description: Contact page for the Magazine demo. Split form + info layout with optional FAQ. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, magazine, contact, form, email, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@magazine.studio">hello@magazine.studio</a></p>
<!-- /wp:paragraph -->
