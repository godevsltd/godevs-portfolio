<?php
/**
 * Title: Demo — Studio Craft (About)
 * Slug: godevs-portfolio/demo-studio-craft-about
 * Description: About page for the Studio Craft demo. Bio intro, practice areas, and a closing CTA. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, studio-craft, about, bio, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Studio Craft is a design practice focused on identity, editorial, and product work.</p>
<!-- /wp:paragraph -->
