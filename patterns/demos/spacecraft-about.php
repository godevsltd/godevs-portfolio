<?php
/**
 * Title: Demo — Spacecraft (About)
 * Slug: godevs-portfolio/demo-spacecraft-about
 * Description: About page for the Spacecraft demo. Bio intro, practice areas, and a closing CTA. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, spacecraft, about, bio, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Spacecraft is an architecture and design practice focused on considered, context-aware work.</p>
<!-- /wp:paragraph -->
