<?php
/**
 * Title: Demo — Professional (About)
 * Slug: godevs-portfolio/demo-professional-about
 * Description: About page for the Professional demo. Bio intro, practice areas, and a closing CTA. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, professional, about, bio, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Professional, a professional portfolio.</p>
<!-- /wp:paragraph -->
