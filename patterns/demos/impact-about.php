<?php
/**
 * Title: Demo — Impact (About)
 * Slug: godevs-portfolio/demo-impact-about
 * Description: About page for the Impact demo. Bio intro, practice areas, and a closing CTA. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, impact, about, bio, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Impact is a consulting practice helping teams make better decisions about their products and processes.</p>
<!-- /wp:paragraph -->
