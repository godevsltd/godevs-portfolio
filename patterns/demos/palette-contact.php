<?php
/**
 * Title: Demo — Palette (Contact)
 * Slug: godevs-portfolio/demo-palette-contact
 * Description: Contact page for the Palette demo. Split form + info layout with optional FAQ. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, palette, contact, form, email, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@palette.studio">hello@palette.studio</a></p>
<!-- /wp:paragraph -->
