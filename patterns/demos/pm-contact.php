<?php
/**
 * Title: Demo — PM (Contact)
 * Slug: godevs-portfolio/demo-pm-contact
 * Description: Contact page for the PM demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, pm, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@pm.studio">hello@pm.studio</a></p>
<!-- /wp:paragraph -->
