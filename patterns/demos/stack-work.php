<?php
/**
 * Title: Demo — Stack (Work)
 * Slug: godevs-portfolio/demo-stack-work
 * Description: Work page for the Stack demo. 2-column portfolio grid with selected projects. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, stack, work, portfolio, grid, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
