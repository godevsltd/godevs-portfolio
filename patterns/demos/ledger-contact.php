<?php
/**
 * Title: Demo — Ledger (Contact)
 * Slug: godevs-portfolio/demo-ledger-contact
 * Description: Contact page for the Ledger demo. Split form + info layout with optional FAQ. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, ledger, contact, form, email, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@ledger.studio">hello@ledger.studio</a></p>
<!-- /wp:paragraph -->
