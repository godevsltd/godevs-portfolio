<?php
/**
 * Title: Demo — Split (Contact)
 * Slug: godevs-portfolio/demo-split-contact
 * Description: Contact page for the Split demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, split, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@split.studio">hello@split.studio</a></p>
<!-- /wp:paragraph -->
