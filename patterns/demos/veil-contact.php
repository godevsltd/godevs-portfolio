<?php
/**
 * Title: Demo — Veil (Contact)
 * Slug: godevs-portfolio/demo-veil-contact
 * Description: Contact page for the Veil demo. Split form + info layout with optional FAQ. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, veil, contact, form, email, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@veil.studio">hello@veil.studio</a></p>
<!-- /wp:paragraph -->
