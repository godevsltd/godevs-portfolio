<?php
/**
 * Title: Demo — Structural (About)
 * Slug: godevs-portfolio/demo-structural-about
 * Description: About page for the Structural demo. Bio intro, practice areas, and a closing CTA. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, structural, about, bio, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Structural is an architecture and design practice focused on considered, context-aware work.</p>
<!-- /wp:paragraph -->
