<?php
/**
 * Title: Demo — Scribe (Work)
 * Slug: godevs-portfolio/demo-scribe-work
 * Description: Work page for the Scribe demo. 2-column portfolio grid with selected projects. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, scribe, work, portfolio, grid, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
