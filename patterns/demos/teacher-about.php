<?php
/**
 * Title: Demo — Teacher (About)
 * Slug: godevs-portfolio/demo-teacher-about
 * Description: About page for the Teacher demo. Bio intro, practice areas, and a closing CTA. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, teacher, about, bio, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Teacher is an academic practice spanning research, teaching, and writing.</p>
<!-- /wp:paragraph -->
