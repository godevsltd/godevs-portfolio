<?php
/**
 * Title: Demo — Exposure (Contact)
 * Slug: godevs-portfolio/demo-exposure-contact
 * Description: Contact page for the Exposure demo. Split form + info layout with optional FAQ. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, exposure, contact, form, email, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@exposure.studio">hello@exposure.studio</a></p>
<!-- /wp:paragraph -->
