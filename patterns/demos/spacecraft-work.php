<?php
/**
 * Title: Demo — Spacecraft (Work)
 * Slug: godevs-portfolio/demo-spacecraft-work
 * Description: Work page for the Spacecraft demo. 2-column portfolio grid with selected projects. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, spacecraft, work, portfolio, grid, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
