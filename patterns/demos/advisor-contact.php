<?php
/**
 * Title: Demo — Advisor (Contact)
 * Slug: godevs-portfolio/demo-advisor-contact
 * Description: Contact page for the Advisor demo. Split form + info layout with optional FAQ. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, advisor, contact, form, email, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@advisor.studio">hello@advisor.studio</a></p>
<!-- /wp:paragraph -->
