<?php
/**
 * Title: Demo — Central (About)
 * Slug: godevs-portfolio/demo-central-about
 * Description: About page for the Central demo. Bio intro, practice areas, and a closing CTA. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, central, about, bio, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Central, a centered personal portfolio.</p>
<!-- /wp:paragraph -->
