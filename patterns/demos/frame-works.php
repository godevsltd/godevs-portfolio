<?php
/**
 * Title: Demo — Frame Works (Production)
 * Slug: godevs-portfolio/demo-frame-works
 * Description: Production studio site. Image-led hero, large showcase portfolio, minimal CTA. Cinematic. Recommended style variation: Dark.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, agency,, production
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-frame-works godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-demo-frame-works alignfull">
...
<p class="is-style-eyebrow has-text-color" style="color:var(--wp--preset--color--muted)">Agency / Production</p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2rem, 5vw, 4rem);line-height:1.1;letter-spacing:-0.02em;font-weight:600">Frame Works.</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|medium"},"layout":{"selfStretch":"fit","flexSize":"520px"}}} -->
<p style="font-size:var(--wp--preset--font-size--medium);max-width:520px">Production studio site. Image-led hero, large showcase portfolio, minimal CTA. Cinematic.</p>
<!-- /wp:paragraph -->
<!-- wp:buttons -->
