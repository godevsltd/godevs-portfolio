<?php
/**
 * Title: Demo — Keystone Pro (About)
 * Slug: godevs-portfolio/demo-keystone-pro-about
 * Description: About page for the Keystone Pro demo. Bio intro, practice areas, and a closing CTA. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, keystone-pro, about, bio, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<h2 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size--xx-large);letter-spacing:-0.02em;font-weight:600">The consulting practice.</h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|medium"},"layout":{"selfStretch":"fit","flexSize":"560px"}}} -->
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Keystone Pro is a consulting practice helping teams make better decisions about their products and processes.</p>
<!-- /wp:paragraph -->
