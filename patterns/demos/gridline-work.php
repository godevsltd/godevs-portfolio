<?php
/**
 * Title: Demo — Gridline (Work)
 * Slug: godevs-portfolio/demo-gridline-work
 * Description: Work page for the Gridline demo. 2-column portfolio grid with selected projects. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, gridline, work, portfolio, grid, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
