<?php
/**
 * Title: Demo — Exposure (Work)
 * Slug: godevs-portfolio/demo-exposure-work
 * Description: Work page for the Exposure demo. 2-column portfolio grid with selected projects. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, exposure, work, portfolio, grid, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
