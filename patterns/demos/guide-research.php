<?php
/**
 * Title: Demo — Guide (Research)
 * Slug: godevs-portfolio/demo-guide-research
 * Description: Research page for the Guide demo. Focus areas and publications framed as a stats/experience composition. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, guide, research, publications, focus areas, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
