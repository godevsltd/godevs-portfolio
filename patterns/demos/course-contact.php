<?php
/**
 * Title: Demo — Course (Contact)
 * Slug: godevs-portfolio/demo-course-contact
 * Description: Contact page for the Course demo. Split form + info layout with optional FAQ. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, course, contact, form, email, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@course.studio">hello@course.studio</a></p>
<!-- /wp:paragraph -->
