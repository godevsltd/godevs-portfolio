<?php
/**
 * Title: Demo — Vertex (Work)
 * Slug: godevs-portfolio/demo-vertex-work
 * Description: Work page for the Vertex demo. 2-column portfolio grid with selected projects. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, vertex, work, portfolio, grid, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
