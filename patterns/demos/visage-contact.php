<?php
/**
 * Title: Demo — Visage (Contact)
 * Slug: godevs-portfolio/demo-visage-contact
 * Description: Contact page for the Visage demo. Split form + info layout with optional FAQ. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, visage, contact, form, email, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@visage.studio">hello@visage.studio</a></p>
<!-- /wp:paragraph -->
