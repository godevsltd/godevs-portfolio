<?php
/**
 * Title: Demo — Thesis (About)
 * Slug: godevs-portfolio/demo-thesis-about
 * Description: About page for the Thesis demo. Bio intro, practice areas, and a closing CTA. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, thesis, about, bio, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Thesis is an academic practice spanning research, teaching, and writing.</p>
<!-- /wp:paragraph -->
