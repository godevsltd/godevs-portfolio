<?php
/**
 * Title: Demo — Technologist (About)
 * Slug: godevs-portfolio/demo-technologist-about
 * Description: About page for the Technologist demo. Bio intro, practice areas, and a closing CTA. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, technologist, about, bio, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Technologist, a creative technologist portfolio.</p>
<!-- /wp:paragraph -->
