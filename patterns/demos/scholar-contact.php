 ...
 * Description: Contact page for the Scholar demo. Academic contact info. Uses the Minimal style variation.
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--serif);font-size:clamp(2rem, 5vw, 3.5rem);line-height:1.1;letter-spacing:-0.025em;font-weight:400">Get in touch.</h1>
<!-- /wp:heading -->
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size|medium);max-width:520px">For research collaborations, guest lectures, or questions about publications. Email is the best way to reach me.</p>
<!-- /wp:paragraph -->
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:research@scholar.academia">research@scholar.academia</a></p>
<!-- /wp:paragraph -->
...
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|medium"}}} -->
<p style="font-size:var(--wp--preset--font-size|medium)">Department of Design<br>Humboldt University, Berlin</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"className":"is-style-eyebrow","style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
<p class="is-style-eyebrow" style="margin-top:var(--wp--preset--spacing--40)">Office hours</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|medium"}}} -->
<p style="font-size:var(--wp--preset--font-size|medium)">Tuesdays 14:00–16:00<br>By appointment</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"className":"is-style-eyebrow","style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
<p class="is-style-eyebrow" style="margin-top:var(--wp--preset--spacing--40)">Profiles</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|medium"}}} -->
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="#">Google Scholar</a> · <a href="#">ORCID</a> · <a href="#">LinkedIn</a></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"60%"} -->
...
<p class="has-text-color has-border-color" style="border-color:var(--wp--preset--color--border);border-width:1px;border-radius:6px;color:var(--wp--preset--color--muted);margin-top:var(--wp--preset--spacing--20);padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)">you@university.edu</p>
<!-- /wp:paragraph -->
...
<p class="has-text-color has-border-color" style="border-color:var(--wp--preset--color--border);border-width:1px;border-radius:6px;color:var(--wp--preset--color--muted);min-height:100px;margin-top:var(--wp--preset--spacing--20);padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)">What would you like to discuss? Research collaboration, guest lecture, or something else?</p>
<!-- /wp:paragraph -->
