<?php
/**
 * Title: Demo — Content (Work)
 * Slug: godevs-portfolio/demo-content-work
 * Description: Work page for the Content demo. 2-column portfolio grid with selected projects. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, content, work, portfolio, grid, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
