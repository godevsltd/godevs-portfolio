<?php
/**
 * Title: Demo — Blueprint (Contact)
 * Slug: godevs-portfolio/demo-blueprint-contact
 * Description: Contact page for the Blueprint demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, blueprint, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@blueprint.studio">hello@blueprint.studio</a></p>
<!-- /wp:paragraph -->
