<?php
/**
 * Title: Demo — Executive (Executive)
 * Slug: godevs-portfolio/demo-executive
 * Description: Executive portfolio. Stats-led hero, résumé-style experience, split CTA. Structured. Recommended style variation: Corporate.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, personal,, executive
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-executive godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-demo-executive alignfull">
                ...
                <div class="wp-block-columns are-vertically-aligned-center">
                        ...
                        <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:55%">
                                ...
                                <div class="wp-block-group">
                                        ...
                                        <p class="is-style-eyebrow">Personal / Executive</p>
                                        <!-- /wp:paragraph -->
                                        ...
                                        <h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size--xx-large);line-height:1.1;letter-spacing:-0.02em">Executive — selected work.</h1>
                                        <!-- /wp:heading -->
                ...
                <div class="wp-block-columns">
                        ...
                        <div class="wp-block-column" style="flex-basis:66.66%">
                                ...
                                <div class="wp-block-group">
                                        ...
                                        <!-- /wp:group -->
                                        <!-- wp:paragraph -->
                                        <p>Working with founders and editorial teams on portfolio, product, and publication sites.</p>
                                        <!-- /wp:paragraph -->
                                        ...
                                        <!-- /wp:group -->
                                        <!-- wp:paragraph -->
                                        <p>Led brand and product design for editorial and SaaS clients.</p>
                                        <!-- /wp:paragraph -->
                                </div>
                                <!-- /wp:group -->
                        </div>
