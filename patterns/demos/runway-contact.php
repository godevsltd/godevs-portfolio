<?php
/**
 * Title: Demo — Runway (Contact)
 * Slug: godevs-portfolio/demo-runway-contact
 * Description: Contact page for the Runway demo. Split form + info layout with optional FAQ. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, runway, contact, form, email, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@runway.studio">hello@runway.studio</a></p>
<!-- /wp:paragraph -->
