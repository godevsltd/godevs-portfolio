<?php
/**
 * Title: Demo — Creator (About)
 * Slug: godevs-portfolio/demo-creator-about
 * Description: About page for the Creator demo. Bio intro, practice areas, and a closing CTA. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, creator, about, bio, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Creator, a online creator portfolio.</p>
<!-- /wp:paragraph -->
