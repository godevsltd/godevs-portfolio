<?php
/**
 * Title: Demo — Technologist (Work)
 * Slug: godevs-portfolio/demo-technologist-work
 * Description: Work page for the Technologist demo. 2-column portfolio grid with selected projects. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, technologist, work, portfolio, grid, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
