<?php
/**
 * Title: Demo — Blueprint Studio (Work)
 * Slug: godevs-portfolio/demo-blueprint-studio-work
 * Description: Work page for the Blueprint Studio demo. 3-column portfolio grid with selected projects. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, blueprint-studio, work, portfolio, grid, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
