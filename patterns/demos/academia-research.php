<?php
/**
 * Title: Demo — Academia (Research)
 * Slug: godevs-portfolio/demo-academia-research
 * Description: Research page for the Academia demo. Focus areas and publications framed as a stats/experience composition. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, academia, research, publications, focus areas, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
