<?php
/**
 * Title: Demo — Couture (Contact)
 * Slug: godevs-portfolio/demo-couture-contact
 * Description: Contact page for the Couture demo. Split form + info layout with optional FAQ. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, couture, contact, form, email, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@couture.studio">hello@couture.studio</a></p>
<!-- /wp:paragraph -->
