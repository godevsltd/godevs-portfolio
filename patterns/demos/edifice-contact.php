<?php
/**
 * Title: Demo — Edifice (Contact)
 * Slug: godevs-portfolio/demo-edifice-contact
 * Description: Contact page for the Edifice demo. Split form + info layout with optional FAQ. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, edifice, contact, form, email, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@edifice.studio">hello@edifice.studio</a></p>
<!-- /wp:paragraph -->
