<?php
/**
 * Title: Demo — Magazine (About)
 * Slug: godevs-portfolio/demo-magazine-about
 * Description: About page for the Magazine demo. Bio intro, practice areas, and a closing CTA. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, magazine, about, bio, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Magazine is a creative practice documenting and designing for considered living.</p>
<!-- /wp:paragraph -->
