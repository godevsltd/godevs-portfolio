...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-fieldnotes godevs-reveal","layout":{"type":"default"}} -->
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2.5rem, 6vw, 5rem);line-height:1.05;letter-spacing:-0.02em;font-weight:600">Fieldnotes</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|medium"},"layout":{"selfStretch":"fit","flexSize":"520px"}}} -->
<p style="font-size:var(--wp--preset--font-size--medium);max-width:520px">Art director portfolio. Editorial typography hero, experience + blog sections, typography CTA.</p>
<!-- /wp:paragraph -->
