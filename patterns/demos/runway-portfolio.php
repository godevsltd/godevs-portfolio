<?php
/**
 * Title: Demo — Runway (Work)
 * Slug: godevs-portfolio/demo-runway-work
 * Description: Work page for the Runway demo. 2-column portfolio grid with selected projects. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, runway, work, portfolio, grid, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
