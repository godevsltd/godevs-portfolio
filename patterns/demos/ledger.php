...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-ledger godevs-reveal","layout":{"type":"default"}} -->
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small)">Business / Financial</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</section>
