<?php
/**
 * Title: Demo — Ledger (Financial)
 * Slug: godevs-portfolio/demo-ledger
 * Description: Financial consultant portfolio. Minimal hero, résumé-style experience, split CTA. Restrained. Recommended style variation: Minimal.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, business,, financial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-ledger","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-demo-ledger alignfull">
...
<section class="wp-block-group alignfull">
        ...
        <div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--90);padding-bottom:var(--wp--preset--spacing--90)">
                ...
                <h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2.5rem, 7vw, 5.5rem);line-height:1;letter-spacing:-0.03em;font-weight:600">Ledger — selected work.</h1>
                <!-- /wp:heading -->
                <!-- wp:separator {"className":"is-style-thin","style":{"spacing":{"margin":{"top":"var:preset|spacing|50"}}}} /-->
                <!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small"},"color":{"text":"var:preset|color|muted"}}} -->
                <p style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--small)">Business / Financial</p>
                <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
</section>
