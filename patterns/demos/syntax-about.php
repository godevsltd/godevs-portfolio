<?php
/**
 * Title: Demo — Syntax (About)
 * Slug: godevs-portfolio/demo-syntax-about
 * Description: About page for the Syntax demo. Bio intro, practice areas, and a closing CTA. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, syntax, about, bio, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Syntax is an independent practice working at the intersection of design and engineering.</p>
<!-- /wp:paragraph -->
