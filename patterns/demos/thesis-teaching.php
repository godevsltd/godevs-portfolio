<?php
/**
 * Title: Demo — Thesis (Teaching)
 * Slug: godevs-portfolio/demo-thesis-teaching
 * Description: Teaching page for the Thesis demo. Courses and programs framed as a services-style composition. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, thesis, teaching, courses, programs, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
