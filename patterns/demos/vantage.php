                ...
                <div class="wp-block-columns are-vertically-aligned-center">
                        ...
                        <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:55%">
                                ...
                                <div class="wp-block-group">
                                        ...
                                        <p class="is-style-eyebrow">Business / Management</p>
                                        <!-- /wp:paragraph -->
                                        ...
                                        <h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size--xx-large);line-height:1.1;letter-spacing:-0.02em">Vantage — selected work.</h1>
                                        <!-- /wp:heading -->
