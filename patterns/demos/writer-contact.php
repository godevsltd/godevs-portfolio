<?php
/**
 * Title: Demo — Writer (Contact)
 * Slug: godevs-portfolio/demo-writer-contact
 * Description: Contact page for the Writer demo. Split form + info layout with optional FAQ. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, writer, contact, form, email, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@writer.studio">hello@writer.studio</a></p>
<!-- /wp:paragraph -->
