<?php
/**
 * Title: Demo — Compile (Contact)
 * Slug: godevs-portfolio/demo-compile-contact
 * Description: Contact page for the Compile demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, compile, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@compile.studio">hello@compile.studio</a></p>
<!-- /wp:paragraph -->
