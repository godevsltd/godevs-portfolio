<?php
/**
 * Title: Demo — Solo Practice (About)
 * Slug: godevs-portfolio/demo-solo-practice-about
 * Description: About page for the Solo Practice demo. Bio intro, practice areas, and a closing CTA. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, solo-practice, about, bio, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Solo Practice is an independent practice working at the intersection of design and engineering.</p>
<!-- /wp:paragraph -->
