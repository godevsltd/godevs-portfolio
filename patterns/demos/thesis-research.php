<?php
/**
 * Title: Demo — Thesis (Research)
 * Slug: godevs-portfolio/demo-thesis-research
 * Description: Research page for the Thesis demo. Focus areas and publications framed as a stats/experience composition. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, thesis, research, publications, focus areas, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
