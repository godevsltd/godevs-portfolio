<?php
/**
 * Title: Demo — Pill (Work)
 * Slug: godevs-portfolio/demo-pill-work
 * Description: Work page for the Pill demo. 4-column portfolio grid with selected projects. Uses the Creative style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, pill, work, portfolio, grid, creative
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
