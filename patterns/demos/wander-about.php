<?php
/**
 * Title: Demo — Wander (About)
 * Slug: godevs-portfolio/demo-wander-about
 * Description: About page for the Wander demo. Bio intro, practice areas, and a closing CTA. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, wander, about, bio, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Wander is a creative practice documenting and designing for considered living.</p>
<!-- /wp:paragraph -->
