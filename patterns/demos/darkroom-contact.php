<?php
/**
 * Title: Demo — Darkroom (Contact)
 * Slug: godevs-portfolio/demo-darkroom-contact
 * Description: Contact page for the Darkroom demo. Split form + info layout with optional FAQ. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, darkroom, contact, form, email, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@darkroom.studio">hello@darkroom.studio</a></p>
<!-- /wp:paragraph -->
