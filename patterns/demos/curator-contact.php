<?php
/**
 * Title: Demo — Curator (Contact)
 * Slug: godevs-portfolio/demo-curator-contact
 * Description: Contact page for the Curator demo. Split form + info layout with optional FAQ. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, curator, contact, form, email, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@curator.studio">hello@curator.studio</a></p>
<!-- /wp:paragraph -->
