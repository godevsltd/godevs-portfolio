<?php
/**
 * Title: Demo — Frame Works (Contact)
 * Slug: godevs-portfolio/demo-frame-works-contact
 * Description: Contact page for the Frame Works demo. Split form + info layout with optional FAQ. Uses the Dark style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, frame-works, contact, form, email, dark
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@frame-works.studio">hello@frame-works.studio</a></p>
<!-- /wp:paragraph -->
