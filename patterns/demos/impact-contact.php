<?php
/**
 * Title: Demo — Impact (Contact)
 * Slug: godevs-portfolio/demo-impact-contact
 * Description: Contact page for the Impact demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, impact, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@impact.studio">hello@impact.studio</a></p>
<!-- /wp:paragraph -->
