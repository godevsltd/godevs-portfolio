<?php
/**
 * Title: Demo — Editorial (Contact)
 * Slug: godevs-portfolio/demo-editorial-contact
 * Description: Contact page for the Editorial demo. Split form + info layout with optional FAQ. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, editorial, contact, form, email, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@editorial.studio">hello@editorial.studio</a></p>
<!-- /wp:paragraph -->
