<?php
/**
 * Title: Demo — Freelance (Freelancer)
 * Slug: godevs-portfolio/demo-freelance
 * Description: Freelancer portfolio. Split hero, services then minimal portfolio, minimal CTA. Restrained. Recommended style variation: Minimal.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, personal,, freelancer
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-freelance godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-demo-freelance alignfull">
