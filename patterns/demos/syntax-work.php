<?php
/**
 * Title: Demo — Syntax (Work)
 * Slug: godevs-portfolio/demo-syntax-work
 * Description: Work page for the Syntax demo. 2-column portfolio grid with selected projects. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, syntax, work, portfolio, grid, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
