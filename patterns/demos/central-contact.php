<?php
/**
 * Title: Demo — Central (Contact)
 * Slug: godevs-portfolio/demo-central-contact
 * Description: Contact page for the Central demo. Split form + info layout with optional FAQ. Uses the Elegant style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, central, contact, form, email, elegant
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@central.studio">hello@central.studio</a></p>
<!-- /wp:paragraph -->
