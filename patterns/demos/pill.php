<?php
/**
 * Title: Demo — Pill (Portfolio CTA)
 * Slug: godevs-portfolio/demo-pill
 * Description: Designer portfolio with pill CTA header. Centered intro, dense four-column grid, full-width CTA. Recommended style variation: Creative.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, designer,, portfolio, cta
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-pill godevs-reveal","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-demo-pill alignfull">
