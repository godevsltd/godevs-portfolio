<?php
/**
 * Title: Demo — Editorial (About)
 * Slug: godevs-portfolio/demo-editorial-about
 * Description: About page for the Editorial demo. Bio intro, practice areas, and a closing CTA. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, editorial, about, bio, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Editorial is a creative practice documenting and designing for considered living.</p>
<!-- /wp:paragraph -->
