<?php
/**
 * Title: Demo — Polyglot (Work)
 * Slug: godevs-portfolio/demo-polyglot-work
 * Description: Work page for the Polyglot demo. 3-column portfolio grid with selected projects. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, polyglot, work, portfolio, grid, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
