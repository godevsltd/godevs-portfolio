<?php
/**
 * Title: Demo — Vantage (Contact)
 * Slug: godevs-portfolio/demo-vantage-contact
 * Description: Contact page for the Vantage demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, vantage, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@vantage.studio">hello@vantage.studio</a></p>
<!-- /wp:paragraph -->
