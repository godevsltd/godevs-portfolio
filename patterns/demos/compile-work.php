<?php
/**
 * Title: Demo — Compile (Work)
 * Slug: godevs-portfolio/demo-compile-work
 * Description: Work page for the Compile demo. 2-column portfolio grid with selected projects. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, compile, work, portfolio, grid, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
