<?php
/**
 * Title: Demo — Split (About)
 * Slug: godevs-portfolio/demo-split-about
 * Description: About page for the Split demo. Bio intro, practice areas, and a closing CTA. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, split, about, bio, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Split is an independent practice working at the intersection of design and engineering.</p>
<!-- /wp:paragraph -->
