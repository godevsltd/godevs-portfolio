...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-criterion godevs-reveal","layout":{"type":"default"}} -->
...
<p class="is-style-eyebrow has-text-color" style="color:var(--wp--preset--color--muted)">Business / Strategy</p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2rem, 5vw, 4rem);line-height:1.1;letter-spacing:-0.02em;font-weight:600">Criterion.</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|medium"},"layout":{"selfStretch":"fit","flexSize":"520px"}}} -->
<p style="font-size:var(--wp--preset--font-size--medium);max-width:520px">Strategy consultant portfolio. Stats-led hero, three-column services list, split CTA.</p>
<!-- /wp:paragraph -->
<!-- wp:buttons -->
