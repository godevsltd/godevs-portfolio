<?php
/**
 * Title: Demo — Criterion (Strategy)
 * Slug: godevs-portfolio/demo-criterion
 * Description: Strategy consultant portfolio. Stats-led hero, three-column services list, split CTA. Recommended style variation: Corporate.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, business,, strategy
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
        exit;
...
?>
<!-- wp:group {"tagName":"section","className":"wp-block-godevs-demo-criterion","layout":{"type":"default"}} -->
<section class="wp-block-group wp-block-godevs-demo-criterion alignfull">
                ...
                <div class="wp-block-columns are-vertically-aligned-center">
                        ...
                        <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:55%">
                                ...
                                <div class="wp-block-group">
                                        ...
                                        <p class="is-style-eyebrow">Business / Strategy</p>
                                        <!-- /wp:paragraph -->
                                        ...
                                        <h1 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size--xx-large);line-height:1.1;letter-spacing:-0.02em">Criterion — selected work.</h1>
                                        <!-- /wp:heading -->
