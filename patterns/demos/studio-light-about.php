<?php
/**
 * Title: Demo — Studio Light (About)
 * Slug: godevs-portfolio/demo-studio-light-about
 * Description: About page for the Studio Light demo. Bio intro, practice areas, and a closing CTA. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, studio-light, about, bio, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">Studio Light is a photography practice working across editorial, product, and portrait commissions.</p>
<!-- /wp:paragraph -->
