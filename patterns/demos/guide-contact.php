<?php
/**
 * Title: Demo — Guide (Contact)
 * Slug: godevs-portfolio/demo-guide-contact
 * Description: Contact page for the Guide demo. Split form + info layout with optional FAQ. Uses the Corporate style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, guide, contact, form, email, corporate
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@guide.studio">hello@guide.studio</a></p>
<!-- /wp:paragraph -->
