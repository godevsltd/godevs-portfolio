<?php
/**
 * Title: Demo — Foundry (Contact)
 * Slug: godevs-portfolio/demo-foundry-contact
 * Description: Contact page for the Foundry demo. Split form + info layout with optional FAQ. Uses the Editorial style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, foundry, contact, form, email, editorial
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@foundry.studio">hello@foundry.studio</a></p>
<!-- /wp:paragraph -->
