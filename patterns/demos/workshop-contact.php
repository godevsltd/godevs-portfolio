<?php
/**
 * Title: Demo — Workshop (Contact)
 * Slug: godevs-portfolio/demo-workshop-contact
 * Description: Contact page for the Workshop demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, workshop, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@workshop.studio">hello@workshop.studio</a></p>
<!-- /wp:paragraph -->
