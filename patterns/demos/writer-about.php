<?php
/**
 * Title: Demo — Writer (About)
 * Slug: godevs-portfolio/demo-writer-about
 * Description: About page for the Writer demo. Bio intro, practice areas, and a closing CTA. Uses the Minimal style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, writer, about, bio, minimal
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size--medium);max-width:560px">I'm Writer, a writer portfolio.</p>
<!-- /wp:paragraph -->
