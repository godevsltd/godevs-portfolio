<?php
/**
 * Title: Demo — Grid City (Contact)
 * Slug: godevs-portfolio/demo-grid-city-contact
 * Description: Contact page for the Grid City demo. Split form + info layout with optional FAQ. Uses the Modern style variation.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, grid-city, contact, form, email, modern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<p style="font-size:var(--wp--preset--font-size|medium)"><a href="mailto:hello@grid-city.studio">hello@grid-city.studio</a></p>
<!-- /wp:paragraph -->
