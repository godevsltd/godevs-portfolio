<?php
/**
 * Title: Skills — Skills Grid (Consultant)
 * Slug: godevs-portfolio/skills-skills-grid-surface-consultant-1
 * Description: A skills grid skills section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-skills
 * Keywords: skills, skills grid, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
