<?php
/**
 * Title: Blog — Three Column Grid (Photographer)
 * Slug: godevs-portfolio/blog-blog-grid-constrained-photographer-1
 * Description: A three column grid blog section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-blog
 * Keywords: blog, three column grid, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
