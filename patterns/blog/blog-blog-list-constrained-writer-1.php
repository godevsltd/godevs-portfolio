<?php
/**
 * Title: Blog — Minimal Post List (Writer)
 * Slug: godevs-portfolio/blog-blog-list-constrained-writer-1
 * Description: A minimal post list blog section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-blog
 * Keywords: blog, minimal post list, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
