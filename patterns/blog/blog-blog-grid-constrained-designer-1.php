<?php
/**
 * Title: Blog — Three Column Grid (Designer)
 * Slug: godevs-portfolio/blog-blog-grid-constrained-designer-1
 * Description: A three column grid blog section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-blog
 * Keywords: blog, three column grid, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
