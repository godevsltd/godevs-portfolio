<?php
/**
 * Title: Blog — Minimal Post List (Developer)
 * Slug: godevs-portfolio/blog-blog-list-constrained-developer-1
 * Description: A minimal post list blog section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-blog
 * Keywords: blog, minimal post list, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
