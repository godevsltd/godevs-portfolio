<?php
/**
 * Title: Blog — Minimal Post List (Photographer)
 * Slug: godevs-portfolio/blog-blog-list-constrained-photographer-1
 * Description: A minimal post list blog section with photographer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-blog
 * Keywords: blog, minimal post list, photographer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
