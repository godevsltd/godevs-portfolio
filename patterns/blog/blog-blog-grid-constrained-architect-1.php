<?php
/**
 * Title: Blog — Three Column Grid (Architect)
 * Slug: godevs-portfolio/blog-blog-grid-constrained-architect-1
 * Description: A three column grid blog section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-blog
 * Keywords: blog, three column grid, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
