<?php
/**
 * Title: Blog — Three Column Grid (Agency)
 * Slug: godevs-portfolio/blog-blog-grid-constrained-agency-1
 * Description: A three column grid blog section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-blog
 * Keywords: blog, three column grid, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
