<?php
/**
 * Title: Blog — Three Column Grid (Writer)
 * Slug: godevs-portfolio/blog-blog-grid-constrained-writer-1
 * Description: A three column grid blog section with writer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-blog
 * Keywords: blog, three column grid, writer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
