<?php
/**
 * Title: Blog — Minimal Post List (Architect)
 * Slug: godevs-portfolio/blog-blog-list-constrained-architect-1
 * Description: A minimal post list blog section with architect-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-blog
 * Keywords: blog, minimal post list, architect, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
