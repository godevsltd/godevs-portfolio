<?php
/**
 * Title: Blog — Minimal Post List (Designer)
 * Slug: godevs-portfolio/blog-blog-list-constrained-designer-1
 * Description: A minimal post list blog section with designer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-blog
 * Keywords: blog, minimal post list, designer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
