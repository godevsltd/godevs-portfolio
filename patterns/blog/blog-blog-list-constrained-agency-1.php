<?php
/**
 * Title: Blog — Minimal Post List (Agency)
 * Slug: godevs-portfolio/blog-blog-list-constrained-agency-1
 * Description: A minimal post list blog section with agency-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-blog
 * Keywords: blog, minimal post list, agency, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
