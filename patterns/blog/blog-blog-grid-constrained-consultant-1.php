<?php
/**
 * Title: Blog — Three Column Grid (Consultant)
 * Slug: godevs-portfolio/blog-blog-grid-constrained-consultant-1
 * Description: A three column grid blog section with consultant-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-blog
 * Keywords: blog, three column grid, consultant, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
