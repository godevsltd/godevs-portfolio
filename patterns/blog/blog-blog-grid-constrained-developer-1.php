<?php
/**
 * Title: Blog — Three Column Grid (Developer)
 * Slug: godevs-portfolio/blog-blog-grid-constrained-developer-1
 * Description: A three column grid blog section with developer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-blog
 * Keywords: blog, three column grid, developer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
