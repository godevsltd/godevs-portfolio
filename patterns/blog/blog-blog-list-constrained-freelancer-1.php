<?php
/**
 * Title: Blog — Minimal Post List (Freelancer)
 * Slug: godevs-portfolio/blog-blog-list-constrained-freelancer-1
 * Description: A minimal post list blog section with freelancer-themed content. Uses design tokens and core blocks.
 * Categories: godevs-portfolio-blog
 * Keywords: blog, minimal post list, freelancer, section, pattern
 * Viewport Width: 1280
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
